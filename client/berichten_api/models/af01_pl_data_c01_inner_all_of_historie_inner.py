...
class Af01PlDataC01InnerAllOfHistorieInner(BaseModel):
    """
    Af01PlDataC01InnerAllOfHistorieInner
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["e0110", "e0120", "e0210", "e0220", "e0230", "e0240", "e0310", "e0320", "e0330", "e0410", "e2010", "e2020", "e6110", "e8110", "e8120", "e8210", "e8220", "e8230", "e8310", "e8320", "e8330", "e8410", "e8510", "e8610", "e8810", "e8820"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Af01PlDataC01InnerAllOfHistorieInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Af01PlDataC01InnerAllOfHistorieInner from a dict"""
        if obj is None:
            return None
