...
class Af01PlDataC02Inner(BaseModel):
    """
    Af01PlDataC02Inner
    """ # noqa: E501
    ...
    e6210: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="De datum waarop de familierechtelijke betrekking is ontstaan. ⦿ Groep: Familierechtelijke betrekking (62) ⦿ Element: Datum ingang familierechtelijke betrekking (62.10)")
    ...
    historie: Optional[Annotated[List[Af01PlDataC02InnerAllOfHistorieInner], Field(min_length=1)]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["e0110", "e0120", "e0210", "e0220", "e0230", "e0240", "e0310", "e0320", "e0330", "e0410", "e6210", "e8110", "e8120", "e8210", "e8220", "e8230", "e8310", "e8320", "e8330", "e8410", "e8510", "e8610", "historie"]
    ...
    @field_validator('e6210')
    def e6210_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "e8510": obj.get("e8510"),
            "e8610": obj.get("e8610"),
            "historie": [Af01PlDataC02InnerAllOfHistorieInner.from_dict(_item) for _item in obj["historie"]] if obj.get("historie") is not None else None
        })
