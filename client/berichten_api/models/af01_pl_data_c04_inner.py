...
class Af01PlDataC04Inner(BaseModel):
    """
    Af01PlDataC04Inner
    """ # noqa: E501
    e0510: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=4)]] = Field(default=None, description="Een code, opgenomen in Tabel 32, Nationaliteitentabel, die aangeeft welke nationaliteit de ingeschrevene bezit. ⦿ Groep: Nationaliteit (05) ⦿ Element: Nationaliteit (05.10)")
    e6310: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=3)]] = Field(default=None, description="Een code, opgenomen in Tabel 37, Tabel Reden opnemen/beëindigen nationaliteit, die aanduidt op grond waarvan de ingeschrevene de Nederlandse nationaliteit verkregen heeft dan wel de reden waarom een niet-Nederlandse nationaliteit is opgenomen, dan wel dat het een persoon is waarop het bijzonder Nederlanderschap van toepassing is. ⦿ Groep: Opnemen nationaliteit (63) ⦿ Element: Reden opname nationaliteit (63.10)")
    e6410: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=3)]] = Field(default=None, description="Een code, opgenomen in Tabel 37, Tabel Reden opnemen/beëindigen nationaliteit, die aanduidt op grond waarvan de ingeschrevene de Nederlandse nationaliteit verloren heeft dan wel de reden waarom een niet-Nederlandse nationaliteit is beëindigd, dan wel dat voor een persoon het bijzonder Nederlanderschap niet langer van toepassing is. ⦿ Groep: Beëindigen nationaliteit (64) ⦿ Element: Reden beëindigen nationaliteit (64.10)")
    e6510: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1)]] = Field(default=None, description="Een aanduiding die of aangeeft dat de ingeschrevene behandeld wordt als Nederlander, of dat door de rechter is vastgesteld dat de ingeschrevene niet de Nederlandse nationaliteit bezit. ⦿ Groep: Bijzonder Nederlanderschap (65) ⦿ Element: Aanduiding bijzonder Nederlanderschap (65.10)")
    e7310: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=40)]] = Field(default=None, description="Het persoonsnummer dat door een EU-land is afgegeven aan een onderdaan en dat van het overgelegde reisdocument is afgeleid. ⦿ Groep: Buitenlands persoonsnummer (73) ⦿ Element: EU-persoonsnummer (73.10)")
    ...
    historie: Optional[Annotated[List[Af01PlDataC04InnerAllOfHistorieInner], Field(min_length=1)]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["e0510", "e6310", "e6410", "e6510", "e7310", "e8210", "e8220", "e8230", "e8310", "e8320", "e8330", "e8410", "e8510", "e8610", "e8810", "e8820", "historie"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Af01PlDataC04Inner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Af01PlDataC04Inner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "e8810": obj.get("e8810"),
            "e8820": obj.get("e8820"),
            "historie": [Af01PlDataC04InnerAllOfHistorieInner.from_dict(_item) for _item in obj["historie"]] if obj.get("historie") is not None else None
        })
