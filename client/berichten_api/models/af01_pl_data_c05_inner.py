...
class Af01PlDataC05Inner(BaseModel):
    """
    Af01PlDataC05Inner
    """ # noqa: E501
    ...
    e0610: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="De datum waarop het huwelijk is voltrokken of het partnerschap is aangegaan. ⦿ Groep: Huwelijkssluiting/aangaan geregistreerd partnerschap (06) ⦿ Element: Datum huwelijkssluiting/aangaan geregistreerd partnerschap (06.10)")
    e0620: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=40)]] = Field(default=None, description="Een code, opgenomen in Tabel 33, Gemeententabel of een buitenlandse plaats of een plaatsbepaling, die aangeeft waar het huwelijk is voltrokken of het partnerschap is aangegaan. ⦿ Groep: Huwelijkssluiting/aangaan geregistreerd partnerschap (06) ⦿ Element: Plaats huwelijkssluiting/aangaan geregistreerd partnerschap (06.20)")
    e0630: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=4)]] = Field(default=None, description="Een code, opgenomen in Tabel 34, Landentabel, die het land aangeeft waar het huwelijk is voltrokken of het partnerschap is aangegaan. ⦿ Groep: Huwelijkssluiting/aangaan geregistreerd partnerschap (06) ⦿ Element: Land huwelijkssluiting/aangaan geregistreerd partnerschap (06.30)")
    e0710: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="De datum waarop het huwelijk/geregistreerd partnerschap is ontbonden of nietig verklaard. ⦿ Groep: Ontbinding huwelijk/geregistreerd partnerschap (07) ⦿ Element: Datum ontbinding huwelijk/geregistreerd partnerschap (07.10)")
    e0720: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=40)]] = Field(default=None, description="Een code, opgenomen in Tabel 33, Gemeententabel of een buitenlandse plaats of een plaatsbepaling die aangeeft waar het huwelijk/ geregistreerd partnerschap is ontbonden of nietig verklaard. ⦿ Groep: Ontbinding huwelijk/geregistreerd partnerschap (07) ⦿ Element: Plaats ontbinding huwelijk/geregistreerd partnerschap (07.20)")
    e0730: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=4)]] = Field(default=None, description="Een code, opgenomen in Tabel 34, Landentabel, die het land aangeeft waar het huwelijk/geregistreerd partnerschap is ontbonden of nietig verklaard. ⦿ Groep: Ontbinding huwelijk/geregistreerd partnerschap (07) ⦿ Element: Land ontbinding huwelijk/geregistreerd partnerschap (07.30)")
    e0740: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1)]] = Field(default=None, description="Een code, opgenomen in Tabel 41, Tabel Reden ontbinding/ nietigverklaring huwelijk/geregistreerd partnerschap, die aangeeft om welke reden het huwelijk/geregistreerd partnerschap is ontbonden of nietig verklaard. ⦿ Groep: Ontbinding huwelijk/geregistreerd partnerschap (07) ⦿ Element: Reden ontbinding huwelijk/geregistreerd partnerschap (07.40)")
    e1510: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1)]] = Field(default=None, description="Een aanduiding voor de soort verbintenis die is aangegaan. ⦿ Groep: Soort verbintenis (15) ⦿ Element: Soort verbintenis (15.10)")
    ...
    historie: Optional[Annotated[List[Af01PlDataC05InnerAllOfHistorieInner], Field(min_length=1)]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["e0110", "e0120", "e0210", "e0220", "e0230", "e0240", "e0310", "e0320", "e0330", "e0410", "e0610", "e0620", "e0630", "e0710", "e0720", "e0730", "e0740", "e1510", "e8110", "e8120", "e8210", "e8220", "e8230", "e8310", "e8320", "e8330", "e8410", "e8510", "e8610", "historie"]
    ...
    @field_validator('e0610')
    def e0610_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    @field_validator('e0710')
    def e0710_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Af01PlDataC05Inner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Af01PlDataC05Inner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "e8510": obj.get("e8510"),
            "e8610": obj.get("e8610"),
            "historie": [Af01PlDataC05InnerAllOfHistorieInner.from_dict(_item) for _item in obj["historie"]] if obj.get("historie") is not None else None
        })
