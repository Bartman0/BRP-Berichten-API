...
class Af01PlDataC06Inner(BaseModel):
    """
    Af01PlDataC06Inner
    """ # noqa: E501
    e0810: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="De datum van overlijden. ⦿ Groep: Overlijden (08) ⦿ Element: Datum overlijden (08.10)")
    e0820: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=40)]] = Field(default=None, description="Een code, opgenomen in Tabel 33, Gemeententabel of een buitenlandse plaats of een plaatsbepaling, die aangeeft waar het overlijden heeft plaatsgevonden. ⦿ Groep: Overlijden (08) ⦿ Element: Plaats overlijden (08.20)")
    e0830: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=4)]] = Field(default=None, description="Een code, opgenomen in Tabel 34, Landentabel, die het land aangeeft waar de persoon is overleden. ⦿ Groep: Overlijden (08) ⦿ Element: Land overlijden (08.30)")
    ...
    historie: Optional[Annotated[List[Af01PlDataC06InnerAllOfHistorieInner], Field(min_length=1)]] = None
    __properties: ClassVar[List[str]] = ["e0810", "e0820", "e0830", "e8110", "e8120", "e8210", "e8220", "e8230", "e8310", "e8320", "e8330", "e8410", "e8510", "e8610", "e8810", "e8820", "historie"]

    @field_validator('e0810')
    def e0810_validate_regular_expression(cls, value):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Af01PlDataC06Inner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Af01PlDataC06Inner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "e8810": obj.get("e8810"),
            "e8820": obj.get("e8820"),
            "historie": [Af01PlDataC06InnerAllOfHistorieInner.from_dict(_item) for _item in obj["historie"]] if obj.get("historie") is not None else None
        })
        return _obj
