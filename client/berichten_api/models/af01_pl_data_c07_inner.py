...
class Af01PlDataC07Inner(BaseModel):
    """
    Af01PlDataC07Inner
    """ # noqa: E501
    e6620: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="De datum waarop de gemeente de PL naar een andere gemeente of de RNI stuurt. ⦿ Groep: Blokkering (66) ⦿ Element: Datum ingang blokkering PL (66.20)")
    e6710: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="De datum waarop de bijhouding van de PL (gedeeltelijk) is opgeschort. ⦿ Groep: Opschorting (67) ⦿ Element: Datum opschorting bijhouding (67.10)")
    e6720: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1)]] = Field(default=None, description="Een aanduiding van de reden waarom de bijhouding van de PL geheel of gedeeltelijk is opgeschort. ⦿ Groep: Opschorting (67) ⦿ Element: Omschrijving reden opschorting bijhouding (67.20)")
    e6810: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Dit is de datum vanaf wanneer de persoon is ingeschreven in de BRP. ⦿ Groep: Opname (68) ⦿ Element: Datum eerste inschrijving BRP (68.10)")
    e6910: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=4)]] = Field(default=None, description="Een code, opgenomen in Tabel 33, Gemeententabel, die aangeeft in welke gemeente de PK zich bevindt. ⦿ Groep: Gemeente PK (69) ⦿ Element: Gemeente waar de PK zich bevindt (69.10)")
    e7010: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1)]] = Field(default=None, description="Een aanduiding die aangeeft dat gegevens wel of niet verstrekt mogen worden. ⦿ Groep: Geheim (70) ⦿ Element: Indicatie geheim (70.10)")
    e7110: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="De datum waarop de verificatie van gegevens op de PL in de RNI heeft plaatsgevonden. ⦿ Groep: Verificatie (71) ⦿ Element: Datum verificatie (71.10)")
    e7120: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=50)]] = Field(default=None, description="De omschrijving op welke wijze de verificatie van gegevens op de PL in de RNI heeft plaatsgevonden. ⦿ Groep: Verificatie (71) ⦿ Element: Omschrijving verificatie (71.20)")
    e8010: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=4)]] = Field(default=None, description="Een nummer waarmee de versie van de PL aangegeven wordt. ⦿ Groep: Synchroniciteit (80) ⦿ Element: Versienummer (80.10)")
    e8020: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=17)]] = Field(default=None, description="Dit is de datum en tijd waarop de laatste wijziging of de eerste inschrijving van de PL heeft plaatsgevonden. De op te nemen tijd is Greenwich Mean Time (GMT). ⦿ Groep: Synchroniciteit (80) ⦿ Element: Datumtijdstempel (80.20)")
    e8710: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1)]] = Field(default=None, description="Een aanduiding dat gegevens over alle kinderen van de PK zijn opgenomen in de BRP. ⦿ Groep: PK-conversie (87) ⦿ Element: PK-gegevens volledig meegeconverteerd (87.10)")
    ...
    historie: Optional[Annotated[List[Af01PlDataC07InnerAllOfHistorieInner], Field(min_length=1)]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["e6620", "e6710", "e6720", "e6810", "e6910", "e7010", "e7110", "e7120", "e8010", "e8020", "e8710", "e8810", "e8820", "historie"]

    @field_validator('e6620')
    def e6620_validate_regular_expression(cls, value):
    ...
    @field_validator('e6710')
    def e6710_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    @field_validator('e6810')
    def e6810_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    @field_validator('e7110')
    def e7110_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "e8810": obj.get("e8810"),
            "e8820": obj.get("e8820"),
            "historie": [Af01PlDataC07InnerAllOfHistorieInner.from_dict(_item) for _item in obj["historie"]] if obj.get("historie") is not None else None
        })
