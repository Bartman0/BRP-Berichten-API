...
class Af01PlDataC08Inner(BaseModel):
    """
    Af01PlDataC08Inner
    """ # noqa: E501
    e0910: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=4)]] = Field(default=None, description="Een code, opgenomen in Tabel 33, Gemeententabel, die aangeeft in welke gemeente de PL zich bevindt of de gemeente waarnaar de PL is uitgeschreven of de gemeente waar de PL voor de eerste keer is opgenomen. In categorie 16 betreft het de gemeente waar zich het tijdelijk verblijfsadres bevindt. ⦿ Groep: Gemeente (09) ⦿ Element: Gemeente van inschrijving (09.10)")
    e0920: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Bij een tijdige aangifte (tussen vier weken voor en vijf dagen na de verhuizing) van vestiging in de gemeente is dit de in de aangifte vermelde datum van adreswijziging. Bij een niet tijdige aangifte is dit de aangiftedatum. Bij inschrijving op grond van een geboorteakte is dit de geboortedatum. Bij ambtshalve inschrijving is dit de datum waarop de betrokkene schriftelijk van het voornemen van ambtshalve opneming mededeling is gedaan. In categorie 16 betreft het de datum waarop betrokkene voor het eerst op het tijdelijk verblijfsadres in deze gemeente is gaan wonen, mits deze adressen in de tijd aaneengesloten zijn. ⦿ Groep: Gemeente (09) ⦿ Element: Datum inschrijving (09.20)")
    e1010: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1)]] = Field(default=None, description="De aanduiding die aangeeft of het adres de functie heeft van woonadres of briefadres. ⦿ Groep: Adreshouding (10) ⦿ Element: Functie adres (10.10)")
    e1020: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=24)]] = Field(default=None, description="Een geografisch bepaald gebied dat een deel is van het gemeentelijk grondgebied.  Dit element wordt gebruikt als nadere plaatsbepaling van een straat of locatie, indien deze binnen de gemeente niet uniek is. ⦿ Groep: Adreshouding (10) ⦿ Element: Gemeentedeel (10.20)")
    e1030: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="De datum van aangifte of ambtshalve melding van verblijf en adres. Bij een tijdige aangifte (tussen vier weken voor en vijf dagen na de verhuizing) van vestiging op het adres is dit de in de aangifte vermelde datum van adreswijziging. Bij een niet tijdige aangifte is dit de aangiftedatum. Bij inschrijving op grond van een geboorteakte is dit de geboortedatum. Bij ambtshalve inschrijving is dit de datum waarop de betrokkene schriftelijk van het voornemen van ambtshalve opneming mededeling is gedaan. ⦿ Groep: Adreshouding (10) ⦿ Element: Datum aanvang adreshouding (10.30)")
    e1110: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=24)]] = Field(default=None, description="De officiële straatnaam zoals door het gemeentebestuur is vastgesteld dan wel een kopie van de inhoud van element 11.15 Naam openbare ruimte,  indien noodzakelijk afgekort volgens de NEN-5825 [2002] norm. ⦿ Groep: Adres (11) ⦿ Element: Straatnaam (11.10)")
    e1115: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=80)]] = Field(default=None, description="Een naam die aan een openbare ruimte is toegekend in een daartoe strekkend formeel gemeentelijk besluit. Een openbare ruimte is een door het bevoegde gemeentelijke orgaan als zodanig aangewezen benaming van een binnen één woonplaats gelegen buitenruimte. Voor 'Naam openbare ruimte' mag 'officiële straatnaam' gelezen worden. ⦿ Groep: Adres (11) ⦿ Element: Naam openbare ruimte (11.15)")
    e1120: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=5)]] = Field(default=None, description="De numerieke aanduiding zoals deze door het gemeentebestuur aan het object is toegekend dan wel een door of namens het bevoegde gemeentelijke orgaan ten aanzien van een adresseerbaar object toegekende nummering. ⦿ Groep: Adres (11) ⦿ Element: Huisnummer (11.20)")
    e1130: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1)]] = Field(default=None, description="Een alfabetisch teken achter het huisnummer zoals dit door het gemeentebestuur is toegekend dan wel een door of namens het bevoegde gemeentelijke orgaan ten aanzien van een adresseerbaar object toegekende toevoeging aan een huisnummer in de vorm van een alfabetisch teken. ⦿ Groep: Adres (11) ⦿ Element: Huisletter (11.30)")
    e1140: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=4)]] = Field(default=None, description="Die letters of tekens die noodzakelijk zijn om, naast huisnummer en -letter, de brievenbus te vinden dan wel een door of namens het bevoegde gemeentelijke orgaan ten aanzien van een adresseerbaar object toegekende toevoeging aan een huisnummer of een combinatie van huisletter en huisnummer. ⦿ Groep: Adres (11) ⦿ Element: Huisnummertoevoeging (11.40)")
    e1150: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=2)]] = Field(default=None, description="De aanduiding die wordt gebruikt voor adressen die niet zijn voorzien van de gebruikelijke straatnaam en huisnummeraanduidingen. ⦿ Groep: Adres (11) ⦿ Element: Aanduiding bij huisnummer (11.50)")
    e1160: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="De door de PostNL vastgestelde code behorend bij de straatnaam en het huisnummer dan wel de door PostNL vastgestelde code behorende bij een bepaalde combinatie van een naam openbare ruimte en een huisnummer. ⦿ Groep: Adres (11) ⦿ Element: Postcode (11.60)")
    e1170: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=80)]] = Field(default=None, description="Een woonplaatsnaam is de naam van een door het bevoegde gemeentelijke orgaan als zodanig aangewezen gedeelte van het gemeentelijk grondgebied. ⦿ Groep: Adres (11) ⦿ Element: Woonplaatsnaam (11.70)")
    e1180: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=16)]] = Field(default=None, description="Een verblijfplaats kan een ligplaats, een standplaats of een verblijfsobject in een of meerdere panden zijn, waaraan respectievelijk een ligplaatsidentificatie, standplaatsidentificatie of verblijfsobjectidentificatie is toegekend.  De Identificatiecode verblijfplaats is een combinatie van een viercijferige gemeentecode, een tweecijferige objecttypecode die aangeeft of de aanduiding een verblijfsobject (01), ligplaats (02) of standplaats (03) betreft en een voor het betreffende objecttype binnen een gemeente uniek tiencijferig volgnummer. ⦿ Groep: Adres (11) ⦿ Element: Identificatiecode verblijfplaats (11.80)")
    e1190: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=16)]] = Field(default=None, description="De unieke aanduiding van een nummeraanduiding. Een nummeraanduiding is een door het bevoegde gemeentelijke orgaan als zodanig toegekende aanduiding van een adresseerbaar object.  De Identificatiecode nummeraanduiding is een combinatie van een viercijferige gemeentecode, de tweecijferige objecttypecode 20 die aangeeft dat het om een nummeraanduiding gaat en een voor het betreffende objecttype binnen een gemeente uniek tiencijferig volgnummer. ⦿ Groep: Adres (11) ⦿ Element: Identificatiecode nummeraanduiding (11.90)")
    e1210: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=35)]] = Field(default=None, description="Een geheel of gedeeltelijke omschrijving van de ligging van een object, indien dit niet kan worden aangegeven in de groep 11 Adres. ⦿ Groep: Locatie (12) ⦿ Element: Locatiebeschrijving (12.10)")
    e1310: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=4)]] = Field(default=None, description="Een code, opgenomen in Tabel 34, Landentabel, die het land (buiten Nederland) aangeeft alwaar de ingeschrevene verblijft. In tegenstelling tot bij de gemeente, kan bij de RNI kan de waarde Nederland (6030) wel voorkomen.  Bij het ingaan van een Ministerieel besluit dient hier de standaardwaarde opgenomen te worden. ⦿ Groep: Adres buitenland (13) ⦿ Element: Land adres buitenland (13.10)")
    e1320: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="De datum van aangifte of ambtshalve melding van verblijf op het buitenlands adres.  Bij emigratie is dit de datum van vertrek naar het buitenland. Bij ambtshalve uitschrijving is dit de datum waarop de betrokkene schriftelijk van het voornemen tot ambtshalve uitschrijving mededeling is gedaan. Bij uitschrijving wegens het ingaan van een Ministerieel besluit is dit de datum van dat besluit. In alle andere gevallen is dit de datum waarop de aangifte is ontvangen. ⦿ Groep: Adres buitenland (13) ⦿ Element: Datum aanvang adres buitenland (13.20)")
    e1330: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=35)]] = Field(default=None, description="Eerste deel van het adres in het buitenland, met uitzondering van het land. ⦿ Groep: Adres buitenland (13) ⦿ Element: Regel 1 adres buitenland (13.30)")
    e1340: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=35)]] = Field(default=None, description="Tweede deel van het adres in het buitenland, met uitzondering van het land. ⦿ Groep: Adres buitenland (13) ⦿ Element: Regel 2 adres buitenland (13.40)")
    e1350: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=35)]] = Field(default=None, description="Derde deel van het adres in het buitenland, met uitzondering van het land. ⦿ Groep: Adres buitenland (13) ⦿ Element: Regel 3 adres buitenland (13.50)")
    e1410: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=4)]] = Field(default=None, description="Een code, opgenomen in Tabel 34, Landentabel, die het land aangeeft waar de ingeschrevene verblijf hield voor (her)vestiging in Nederland. Bij het opheffen van een Ministerieel besluit dient hier de standaardwaarde opgenomen te worden. ⦿ Groep: Immigratie (14) ⦿ Element: Land vanwaar ingeschreven (14.10)")
    e1420: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="De datum van inschrijving in Nederland.  Bij ambtshalve inschrijving is dit de datum waarop de betrokkene schriftelijk van het voornemen tot ambtshalve inschrijving mededeling is gedaan. In alle andere gevallen is dit de datum waarop de aangifte is ontvangen. ⦿ Groep: Immigratie (14) ⦿ Element: Datum vestiging in Nederland (14.20)")
    e7210: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1)]] = Field(default=None, description="Een aanduiding van de persoon door wie de aangifte van verblijf en adres is gedaan. ⦿ Groep: Adresaangifte (72) ⦿ Element: Omschrijving van de aangifte adreshouding (72.10)")
    e7510: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1)]] = Field(default=None, description="Een aanduiding dat gedurende de opschorting van de bijhouding van de PL documenten zijn binnengekomen, die na de beëindiging van de opschorting verwerkt moeten worden. ⦿ Groep: Documentindicatie (75) ⦿ Element: Indicatie document (75.10)")
    ...
    historie: Optional[Annotated[List[Af01PlDataC08InnerAllOfHistorieInner], Field(min_length=1)]] = None
    __properties: ClassVar[List[str]] = ["e0910", "e0920", "e1010", "e1020", "e1030", "e1110", "e1115", "e1120", "e1130", "e1140", "e1150", "e1160", "e1170", "e1180", "e1190", "e1210", "e1310", "e1320", "e1330", "e1340", "e1350", "e1410", "e1420", "e7210", "e7510", "e8310", "e8320", "e8330", "e8410", "e8510", "e8610", "e8810", "e8820", "historie"]

    @field_validator('e0920')
    def e0920_validate_regular_expression(cls, value):
    ...
    @field_validator('e1030')
    def e1030_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    @field_validator('e1160')
    def e1160_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    @field_validator('e1320')
    def e1320_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    @field_validator('e1420')
    def e1420_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "e8810": obj.get("e8810"),
            "e8820": obj.get("e8820"),
            "historie": [Af01PlDataC08InnerAllOfHistorieInner.from_dict(_item) for _item in obj["historie"]] if obj.get("historie") is not None else None
        })
        return _obj
