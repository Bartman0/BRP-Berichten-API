...
class Af01PlDataC09Inner(BaseModel):
    """
    Af01PlDataC09Inner
    """ # noqa: E501
    ...
    e8910: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1)]] = Field(default=None, description="De indicatie dat een kind levenloos is geboren. ⦿ Groep: Registratie afstamming (89) ⦿ Element: Registratie betrekking (89.10)")
    historie: Optional[Annotated[List[Af01PlDataC09InnerAllOfHistorieInner], Field(min_length=1)]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["e0110", "e0120", "e0210", "e0220", "e0230", "e0240", "e0310", "e0320", "e0330", "e8110", "e8120", "e8210", "e8220", "e8230", "e8310", "e8320", "e8330", "e8410", "e8510", "e8610", "e8910", "historie"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Af01PlDataC09Inner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Af01PlDataC09Inner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "e8610": obj.get("e8610"),
            "e8910": obj.get("e8910"),
            "historie": [Af01PlDataC09InnerAllOfHistorieInner.from_dict(_item) for _item in obj["historie"]] if obj.get("historie") is not None else None
        })
