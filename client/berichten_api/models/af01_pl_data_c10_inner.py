...
class Af01PlDataC10Inner(BaseModel):
    """
    Af01PlDataC10Inner
    """ # noqa: E501
    e3910: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=2)]] = Field(default=None, description="Een code, opgenomen in Tabel 56, Verblijfstiteltabel, die aangeeft over welke verblijfsrechtelijke status de ingeschrevene beschikt. ⦿ Groep: Verblijfstitel (39) ⦿ Element: Aanduiding verblijfstitel (39.10)")
    e3920: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="De datum waarop de verblijfstitel zijn geldigheid verliest.  Dit element wordt uitsluitend opgenomen indien er sprake is van een verblijfstitel voor bepaalde tijd. Bij een verblijfstitel voor het leven komt het element niet voor. ⦿ Groep: Verblijfstitel (39) ⦿ Element: Datum einde verblijfstitel (39.20)")
    e3930: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="De datum waarop de verblijfstitel zijn geldigheid krijgt. ⦿ Groep: Verblijfstitel (39) ⦿ Element: Ingangsdatum verblijfstitel (39.30)")
    ...
    historie: Optional[Annotated[List[Af01PlDataC10InnerAllOfHistorieInner], Field(min_length=1)]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["e3910", "e3920", "e3930", "e8310", "e8320", "e8330", "e8410", "e8510", "e8610", "historie"]

    @field_validator('e3920')
    def e3920_validate_regular_expression(cls, value):
    ...
    @field_validator('e3930')
    def e3930_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "e8510": obj.get("e8510"),
            "e8610": obj.get("e8610"),
            "historie": [Af01PlDataC10InnerAllOfHistorieInner.from_dict(_item) for _item in obj["historie"]] if obj.get("historie") is not None else None
        })
