...
class Af01PlDataC11Inner(BaseModel):
    """
    Af01PlDataC11Inner
    """ # noqa: E501
    e3210: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=2)]] = Field(default=None, description="Een aanduiding die aangeeft wie belast is met het gezag over de minderjarige ingeschrevene. ⦿ Groep: Gezag minderjarige (32) ⦿ Element: Indicatie gezag minderjarige (32.10)")
    e3310: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1)]] = Field(default=None, description="Een aanduiding dat de ingeschrevene onder curatele is gesteld. ⦿ Groep: Curatele (33) ⦿ Element: Indicatie curateleregister (33.10)")
    ...
    historie: Optional[Annotated[List[Af01PlDataC11InnerAllOfHistorieInner], Field(min_length=1)]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["e3210", "e3310", "e8210", "e8220", "e8230", "e8310", "e8320", "e8330", "e8410", "e8510", "e8610", "historie"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "e8510": obj.get("e8510"),
            "e8610": obj.get("e8610"),
            "historie": [Af01PlDataC11InnerAllOfHistorieInner.from_dict(_item) for _item in obj["historie"]] if obj.get("historie") is not None else None
        })
