...
class Af01PlDataC12Inner(BaseModel):
    """
    Af01PlDataC12Inner
    """ # noqa: E501
    e3510: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=2)]] = Field(default=None, description="Een codering, opgenomen in Tabel 48, Tabel Nederlands reisdocument, die aangeeft welk Nederlands reisdocument is verstrekt of in welk reisdocument de ingeschrevene is bijgeschreven. ⦿ Groep: Nederlands reisdocument (35) ⦿ Element: Soort Nederlands reisdocument (35.10)")
    e3520: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=9)]] = Field(default=None, description="Het nummer van het verstrekte Nederlandse reisdocument of het nummer van het Nederlandse reisdocument waarin de ingeschrevene is bijgeschreven. ⦿ Groep: Nederlands reisdocument (35) ⦿ Element: Nummer Nederlands reisdocument (35.20)")
    e3530: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="De datum waarop het Nederlands reisdocument is uitgegeven of de datum van bijschrijving van de ingeschrevene in een Nederlands reisdocument. ⦿ Groep: Nederlands reisdocument (35) ⦿ Element: Datum uitgifte Nederlands reisdocument (35.30)")
    e3540: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=6)]] = Field(default=None, description="Een codering, opgenomen in Tabel 49, Tabel Autoriteit van afgifte Nederlands reisdocument, die aangeeft welke autoriteit het Nederlands reisdocument heeft verstrekt of de bijschrijving heeft verricht. ⦿ Groep: Nederlands reisdocument (35) ⦿ Element: Autoriteit van afgifte Nederlands reisdocument (35.40)")
    e3550: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="De datum waarop een Nederlands reisdocument, dat aan de ingeschrevene is verstrekt of waarin de ingeschrevene is bijgeschreven, zijn geldigheid verliest. ⦿ Groep: Nederlands reisdocument (35) ⦿ Element: Datum einde geldigheid Nederlands reisdocument (35.50)")
    e3560: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="De datum waarop een Nederlands reisdocument is vermist, ingehouden, ingeleverd, dan wel van rechtswege is vervallen. ⦿ Groep: Nederlands reisdocument (35) ⦿ Element: Datum inhouding dan wel vermissing Nederlands reisdocument (35.60)")
    e3570: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1)]] = Field(default=None, description="Een aanduiding dat een Nederlands reisdocument is vermist, ingehouden, ingeleverd, dan wel van rechtswege is vervallen. ⦿ Groep: Nederlands reisdocument (35) ⦿ Element: Aanduiding inhouding dan wel vermissing Nederlands reisdocument (35.70)")
    e3610: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1)]] = Field(default=None, description="Een aanduiding dat aan de ingeschrevene geen reisdocument mag worden verstrekt. ⦿ Groep: Signalering (36) ⦿ Element: Signalering met betrekking tot verstrekken Nederlands reisdocument (36.10)")
    ...
    historie: Optional[Annotated[List[Af01PlDataC12InnerAllOfHistorieInner], Field(min_length=1)]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["e3510", "e3520", "e3530", "e3540", "e3550", "e3560", "e3570", "e3610", "e8210", "e8220", "e8230", "e8310", "e8320", "e8330", "e8510", "e8610", "historie"]

    @field_validator('e3530')
    def e3530_validate_regular_expression(cls, value):
    ...
    @field_validator('e3550')
    def e3550_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    @field_validator('e3560')
    def e3560_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Af01PlDataC12Inner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Af01PlDataC12Inner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "e8510": obj.get("e8510"),
            "e8610": obj.get("e8610"),
            "historie": [Af01PlDataC12InnerAllOfHistorieInner.from_dict(_item) for _item in obj["historie"]] if obj.get("historie") is not None else None
        })
