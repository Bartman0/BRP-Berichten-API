...
class Af01PlDataC13Inner(BaseModel):
    """
    Af01PlDataC13Inner
    """ # noqa: E501
    ...
    historie: Optional[Annotated[List[Af01PlDataC13InnerAllOfHistorieInner], Field(min_length=1)]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["e3110", "e3120", "e3130", "e3140", "e3150", "e3160", "e3810", "e3820", "e8210", "e8220", "e8230", "historie"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "e8220": obj.get("e8220"),
            "e8230": obj.get("e8230"),
            "historie": [Af01PlDataC13InnerAllOfHistorieInner.from_dict(_item) for _item in obj["historie"]] if obj.get("historie") is not None else None
        })
