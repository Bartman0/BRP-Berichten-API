...
class Af01PlDataC14Inner(BaseModel):
    """
    Af01PlDataC14Inner
    """ # noqa: E501
    e4010: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=6)]] = Field(default=None, description="Een code, opgenomen in Tabel 35, Autorisatietabel, die het nummer aangeeft dat door RvIG wordt toegekend aan een geautoriseerde afnemer of derde die recht heeft op verstrekking van spontane mutaties. ⦿ Groep: Afnemer (40) ⦿ Element: Afnemersindicatie (40.10)")
    ...
    historie: Optional[Annotated[List[Af01PlDataC14InnerAllOfHistorieInner], Field(min_length=1)]] = None
    __properties: ClassVar[List[str]] = ["e4010", "e8510", "historie"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "e4010": obj.get("e4010"),
            "e8510": obj.get("e8510"),
            "historie": [Af01PlDataC14InnerAllOfHistorieInner.from_dict(_item) for _item in obj["historie"]] if obj.get("historie") is not None else None
        })
        return _obj
