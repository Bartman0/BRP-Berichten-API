...
class Af01PlDataC15Inner(BaseModel):
    """
    Af01PlDataC15Inner
    """ # noqa: E501
    e4210: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=24)]] = Field(default=None, description="Een uit vak 6 of vak 23 van de PK afkomstige afnemersaantekening. ⦿ Groep: Aantekening (42) ⦿ Element: Aantekening (42.10)")
    historie: Optional[Annotated[List[Af01PlDataC15InnerAllOfHistorieInner], Field(min_length=1)]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["e4210", "historie"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "e4210": obj.get("e4210"),
            "historie": [Af01PlDataC15InnerAllOfHistorieInner.from_dict(_item) for _item in obj["historie"]] if obj.get("historie") is not None else None
        })
