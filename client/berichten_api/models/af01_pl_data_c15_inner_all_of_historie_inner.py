...
class Af01PlDataC15InnerAllOfHistorieInner(BaseModel):
    """
    Af01PlDataC15InnerAllOfHistorieInner
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["e4210"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Af01PlDataC15InnerAllOfHistorieInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Af01PlDataC15InnerAllOfHistorieInner from a dict"""
        if obj is None:
            return None
