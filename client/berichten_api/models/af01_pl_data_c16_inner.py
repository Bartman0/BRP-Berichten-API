...
class Af01PlDataC16Inner(BaseModel):
    """
    Af01PlDataC16Inner
    """ # noqa: E501
    ...
    e1810: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="De datum waarop betrokkene niet meer zijn tijdelijk verblijfsadres op dit adres houdt. ⦿ Groep: Einde geldigheid (18) ⦿ Element: Einddatum geldigheid (18.10)")
    e1910: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=1)]] = Field(default=None, description="Beschrijving wat de relatie van de betrokken persoon met dit adres. ⦿ Groep: Type adres (19) ⦿ Element: Type adres (19.10)")
    ...
    historie: Optional[Annotated[List[Af01PlDataC16InnerAllOfHistorieInner], Field(min_length=1)]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["e0910", "e0920", "e1110", "e1115", "e1120", "e1130", "e1140", "e1150", "e1160", "e1170", "e1180", "e1190", "e1810", "e1910", "e7210", "e8310", "e8320", "e8330", "e8410", "e8510", "e8610", "e8810", "e8820", "historie"]
    ...
    @field_validator('e1810')
    def e1810_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Af01PlDataC16Inner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Af01PlDataC16Inner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "e8810": obj.get("e8810"),
            "e8820": obj.get("e8820"),
            "historie": [Af01PlDataC16InnerAllOfHistorieInner.from_dict(_item) for _item in obj["historie"]] if obj.get("historie") is not None else None
        })
