...
class Af01PlDataC17Inner(BaseModel):
    """
    Af01PlDataC17Inner
    """ # noqa: E501
    e1610: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=15)]] = Field(default=None, description="Het telefoonnummer waarop betrokkene bereikbaar is. ⦿ Groep: Telefoon (16) ⦿ Element: Telefoonnummer (16.10)")
    e1620: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=2)]] = Field(default=None, description="Een aanduiding die aangeeft of is vastgesteld dat het een geldig telefoonnummer is en of is vastgesteld dat de betrokken persoon via dit telefoonnummer kan worden bereikt. ⦿ Groep: Telefoon (16) ⦿ Element: Verificatie-indicatie (16.20)")
    e1630: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="De datum waarop dit telefoonnummer is geregistreerd. ⦿ Groep: Telefoon (16) ⦿ Element: Geldig vanaf (16.30)")
    e1710: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=255)]] = Field(default=None, description="Het e-mailadres waarop betrokkene bereikbaar is. ⦿ Groep: E-mailadres (17) ⦿ Element: E-mailadres (17.10)")
    e1720: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=2)]] = Field(default=None, description="Een aanduiding die aangeeft of is vastgesteld dat het een geldig e-mailadres is en of is vastgesteld dat de betrokken persoon via dit e-mailadres kan worden bereikt. ⦿ Groep: E-mailadres (17) ⦿ Element: Verificatie-indicatie (17.20)")
    e1730: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="De datum waarop dit e-mailadres is geregistreerd. ⦿ Groep: E-mailadres (17) ⦿ Element: Geldig vanaf (17.30)")
    ...
    historie: Optional[Annotated[List[Af01PlDataC17InnerAllOfHistorieInner], Field(min_length=1)]] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["e1610", "e1620", "e1630", "e1710", "e1720", "e1730", "e8810", "e8820", "historie"]

    @field_validator('e1630')
    def e1630_validate_regular_expression(cls, value):
    ...
    @field_validator('e1730')
    def e1730_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "e8810": obj.get("e8810"),
            "e8820": obj.get("e8820"),
            "historie": [Af01PlDataC17InnerAllOfHistorieInner.from_dict(_item) for _item in obj["historie"]] if obj.get("historie") is not None else None
        })
