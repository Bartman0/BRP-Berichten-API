...
class Af01PlDataC21Inner(BaseModel):
    """
    Af01PlDataC21Inner
    """ # noqa: E501
    ...
    historie: Optional[Annotated[List[Af01PlDataC21InnerAllOfHistorieInner], Field(min_length=1)]] = None
    __properties: ClassVar[List[str]] = ["e0110", "e0120", "e0210", "e0220", "e0230", "e0240", "e0310", "e0320", "e0330", "e0910", "e0920", "e7010", "e8310", "e8320", "e8330", "e8410", "e8510", "e8610", "historie"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of Af01PlDataC21Inner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of Af01PlDataC21Inner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "e8510": obj.get("e8510"),
            "e8610": obj.get("e8610"),
            "historie": [Af01PlDataC21InnerAllOfHistorieInner.from_dict(_item) for _item in obj["historie"]] if obj.get("historie") is not None else None
        })
        return _obj
