...
class Ag01(BaseModel):
    ...
    status: Annotated[str, Field(min_length=1, strict=True, max_length=1)]
    datum: Annotated[str, Field(min_length=0, strict=True, max_length=8)]
    pl_data: Af01PlData = Field(alias="plData")
    __properties: ClassVar[List[str]] = ["$schema", "berichtType", "status", "datum", "plData"]
