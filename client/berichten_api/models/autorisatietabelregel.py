...
class Autorisatietabelregel(BaseModel):
    """
    ...
    """ # noqa: E501
    e9510: Annotated[str, Field(min_length=6, strict=True, max_length=6)] = Field(alias="E9510")
    e9511: Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=24)]], Field(min_length=0)] = Field(description="Dit veld komt alleen in oude tabelregels voor (N-maal)", alias="E9511")
    e9512: Annotated[str, Field(min_length=1, strict=True, max_length=1)] = Field(description="Numeriek: 0 = geheimhouding niet van toepassing, 1 = geheimhouding van toepassing", alias="E9512")
    e9513: Annotated[str, Field(min_length=1, strict=True, max_length=1)] = Field(description="Numeriek: 0 = geen beperking, 1 = gevoelig, 2 = geheim", alias="E9513")
    e9514: Annotated[str, Field(min_length=0, strict=True, max_length=1)] = Field(description="Numeriek: 0 = niet verstrekken, 1 = verstrekken", alias="E9514")
    e9520: Annotated[str, Field(min_length=0, strict=True, max_length=80)] = Field(alias="E9520")
    e9540: Annotated[List[Annotated[str, Field(min_length=6, strict=True, max_length=6)]], Field(min_length=0)] = Field(description="Numeriek (N maal)", alias="E9540")
    e9541: Annotated[str, Field(min_length=0, strict=True, max_length=4096)] = Field(alias="E9541")
    e9542: Annotated[List[Annotated[str, Field(min_length=6, strict=True, max_length=6)]], Field(min_length=0)] = Field(description="Numeriek (N maal)", alias="E9542")
    e9543: Annotated[str, Field(min_length=0, strict=True, max_length=1)] = Field(description="0 = plaatsen afnemersindicatie, 1 = conditionele gegevensverstrekking", alias="E9543")
    e9544: Annotated[str, Field(min_length=0, strict=True, max_length=1)] = Field(description="N = Berichtendienst, A = alternatief medium", alias="E9544")
    e9550: Annotated[List[Annotated[str, Field(min_length=6, strict=True, max_length=6)]], Field(min_length=0)] = Field(description="Numeriek (N maal)", alias="E9550")
    e9551: Annotated[str, Field(min_length=0, strict=True, max_length=4096)] = Field(alias="E9551")
    e9552: Annotated[str, Field(min_length=0, strict=True, max_length=1)] = Field(description="Numeriek: 0 = niet plaatsen, 1 = plaatsen, 2 = logisch verwijderen, 3 = voorwaardelijk fysiek verwijderen, 4 = onvoorwaardelijk fysiek verwijderen", alias="E9552")
    e9553: Annotated[str, Field(min_length=0, strict=True, max_length=1)] = Field(description="Numeriek: 0 = niet verstrekken, 1 = verstrekken", alias="E9553")
    e9554: Annotated[str, Field(min_length=0, strict=True, max_length=8)] = Field(description="Numeriek: jjjjmmdd", alias="E9554")
    e9555: Annotated[str, Field(min_length=0, strict=True, max_length=2)] = Field(alias="E9555")
    e9556: Annotated[str, Field(min_length=0, strict=True, max_length=1)] = Field(description="Alfanumeriek: N = Berichtendienst, webservice of API; A = alternatief medium", alias="E9556")
    e9560: Annotated[List[Annotated[str, Field(min_length=0, strict=True, max_length=6)]], Field(min_length=0)] = Field(description="Numeriek (N maal)", alias="E9560")
    e9561: Annotated[str, Field(min_length=0, strict=True, max_length=4096)] = Field(alias="E9561")
    e9562: Annotated[str, Field(min_length=0, strict=True, max_length=1)] = Field(description="Numeriek: 0 = niet bevoegd, 1 = bevoegd", alias="E9562")
    e9563: Annotated[List[Annotated[str, Field(min_length=6, strict=True, max_length=6)]], Field(min_length=0)] = Field(description="Numeriek (N maal)", alias="E9563")
    e9566: Annotated[str, Field(min_length=0, strict=True, max_length=1)] = Field(description="Numeriek: 0 = niet bevoegd, 1 = bevoegd", alias="E9566")
    e9567: Annotated[str, Field(min_length=0, strict=True, max_length=1)] = Field(description="Alfanumeriek: N = Berichtendienst, webservice of API; A = alternatief medium", alias="E9567")
    e9570: Annotated[List[Annotated[str, Field(min_length=6, strict=True, max_length=6)]], Field(min_length=0)] = Field(description="Numeriek: dit veld komt alleen in oude tabelregels voor; N maal", alias="E9570")
    e9571: Annotated[str, Field(min_length=0, strict=True, max_length=4096)] = Field(description="Alfamumeriek: dit veld komt alleen in oude tabelregels voor", alias="E9571")
    e9573: Annotated[str, Field(min_length=0, strict=True, max_length=1)] = Field(description="Alfamumeriek: N = Berichtendienst, A = alternatief medium; dit veld komt alleen in oude tabelregels voor", alias="E9573")
    e9998: Annotated[str, Field(min_length=0, strict=True, max_length=8)] = Field(description="Numeriek: jjjjmmdd", alias="E9998")
    e9999: Annotated[str, Field(min_length=0, strict=True, max_length=8)] = Field(description="Numeriek: jjjjmmdd", alias="E9999")
    __properties: ClassVar[List[str]] = ["E9510", "E9511", "E9512", "E9513", "E9514", "E9520", "E9540", "E9541", "E9542", "E9543", "E9544", "E9550", "E9551", "E9552", "E9553", "E9554", "E9555", "E9556", "E9560", "E9561", "E9562", "E9563", "E9566", "E9567", "E9570", "E9571", "E9573", "E9998", "E9999"]
