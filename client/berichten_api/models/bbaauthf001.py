...
class BBAAUTHF001(BaseModel):
    """
    Onjuiste of onbekende authenticatie.
    """ # noqa: E501
    title: StrictStr = Field(description="Authenticatiefout")
    type: StrictStr = Field(description="https://www.rvig.nl/brp/berichten-api/probleem/BBA-AUTH-F001")
    detail: StrictStr = Field(description="Onjuiste of onbekende authenticatie.")
    status: StrictInt = Field(description="401")
    ...
    __properties: ClassVar[List[str]] = ["title", "type", "detail", "status", "dateTime", "instance"]
