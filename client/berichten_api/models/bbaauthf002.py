...
class BBAAUTHF002(BaseModel):
    """
    Het account is geblokkeerd.
    """ # noqa: E501
    title: StrictStr = Field(description="Authenticatiefout")
    type: StrictStr = Field(description="https://www.rvig.nl/brp/berichten-api/probleem/BBA-AUTH-F002")
    detail: StrictStr = Field(description="Het account is geblokkeerd.")
