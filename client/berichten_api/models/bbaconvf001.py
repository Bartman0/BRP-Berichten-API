...
class BBACONVF001(BaseModel):
    """
    Bronformaat en doelformaat zijn gelijk aan elkaar
    """ # noqa: E501
    title: StrictStr = Field(description="Bronformaat en doelformaat zijn gelijk aan elkaar")
    type: StrictStr = Field(description="https://www.rvig.nl/brp/berichten-api/probleem/BBA-CONV-F001")
    detail: StrictStr = Field(description="bronformaat '[bronformaat]' is gelijk aan doelformaat '[doelformaat]'")
    invalid_parameters: List[InvalidParametersInner] = Field(alias="invalidParameters")
    ...
    __properties: ClassVar[List[str]] = ["title", "type", "detail", "invalidParameters", "dateTime", "instance"]
