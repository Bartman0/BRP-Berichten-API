...
class BBACONVF002(BaseModel):
    """
    Content-Type header niet aanwezig
    """ # noqa: E501
    title: StrictStr = Field(description="Content-Type header niet aanwezig")
    type: StrictStr = Field(description="https://www.rvig.nl/brp/berichten-api/probleem/BBA-CONV-F002")
    detail: StrictStr = Field(description="Er is geen 'Content-Type:' header meegegeven waardoor niet bepaald kon worden welk bron formaat er geleverd is.")
