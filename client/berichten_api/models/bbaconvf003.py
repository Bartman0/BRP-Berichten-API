...
class BBACONVF003(BaseModel):
    """
    Er is geen 'Content-Type:' header meegegeven waardoor niet bepaald kon worden welk bron formaat er geleverd is.
    """ # noqa: E501
    title: StrictStr = Field(description="Ongeldig bronformaat aangevraagd in 'Content-Type' header")
    type: StrictStr = Field(description="https://www.rvig.nl/brp/berichten-api/probleem/BBA-CONV-F003")
    detail: StrictStr = Field(description="Kon bronformaat niet bepalen a.d.h.v. Content-type header [content-type].")
