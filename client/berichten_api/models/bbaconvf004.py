...
class BBACONVF004(BaseModel):
    """
    Accept header niet aanwezig
    """ # noqa: E501
    title: StrictStr = Field(description="Accept header niet aanwezig")
    type: StrictStr = Field(description="https://www.rvig.nl/brp/berichten-api/probleem/BBA-CONV-F004")
    detail: StrictStr = Field(description="Er is geen 'Accept:' header meegegeven waardoor niet bepaald kon worden welk doelformaat er gevraagd is.")
