...
class BBACONVF005(BaseModel):
    """
    Ongeldig doelformaat aangevraagd in 'Accept' header
    """ # noqa: E501
    title: StrictStr = Field(description="Ongeldig doelformaat aangevraagd in 'Accept' header")
    type: StrictStr = Field(description="https://www.rvig.nl/brp/berichten-api/probleem/BBA-CONV-F005")
    detail: StrictStr = Field(description="Kon doelformaat niet bepalen a.d.h.v. Accept header: [accept-header]")
