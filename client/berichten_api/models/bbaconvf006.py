...
class BBACONVF006(BaseModel):
    """
    Inputbericht is niet valide
    """ # noqa: E501
    title: StrictStr = Field(description="Inputbericht is niet valide")
    type: StrictStr = Field(description="https://www.rvig.nl/brp/berichten-api/probleem/BBA-CONV-F006")
    detail: StrictStr = Field(description="Het aangeleverde bericht kon niet ingenomen worden en voldoet waarschijnlijk niet aan de gestelde vereisten, foutmelding was: [foutmelding]")
    ...
    __properties: ClassVar[List[str]] = ["title", "type", "detail", "dateTime", "instance"]
