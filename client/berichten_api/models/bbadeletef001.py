...
class BBADELETEF001(BaseModel):
    """
    Het bericht is niet langer beschikbaar omdat de retentietijd verstreken is.
    """ # noqa: E501
    title: StrictStr = Field(description="DELETEREQUEST_MESSAGE_EXPIRED")
    type: StrictStr = Field(description="https://www.rvig.nl/brp/berichten-api/probleem/BBA-DELETE-F001")
    detail: StrictStr = Field(description="Het bericht is niet langer beschikbaar omdat de retentietijd verstreken is.")
