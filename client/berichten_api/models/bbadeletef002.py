...
class BBADELETEF002(BaseModel):
    """
    Het bericht is niet langer beschikbaar omdat het reeds verwijderd is.
    """ # noqa: E501
    title: StrictStr = Field(description="DELETEREQUEST_MESSAGE_DELETED")
    type: StrictStr = Field(description="https://www.rvig.nl/brp/berichten-api/probleem/BBA-DELETE-F002")
    detail: StrictStr = Field(description="Het bericht is niet langer beschikbaar omdat het reeds verwijderd is.")
    date_time: Optional[datetime] = Field(default=None, alias="dateTime")
    __properties: ClassVar[List[str]] = ["title", "type", "detail", "dateTime"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BBADELETEF002 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BBADELETEF002 from a dict"""
        if obj is None:
            return None
