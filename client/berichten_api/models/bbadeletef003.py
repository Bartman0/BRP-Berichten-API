...
class BBADELETEF003(BaseModel):
    """
    Onbekend berichtTransportId
    """ # noqa: E501
    title: StrictStr = Field(description="DELETEREQUEST_MESSAGE_NOT_FOUND")
    type: StrictStr = Field(description="https://www.rvig.nl/brp/berichten-api/probleem/BBA-DELETE-F003")
    detail: StrictStr = Field(description="Onbekend berichtTransportId")
