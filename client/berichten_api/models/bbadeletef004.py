...
class BBADELETEF004(BaseModel):
    """
    Het aantal berichten dat in dit verzoek verwijderd dient te worden overschrijft het ingestelde limiet
    """ # noqa: E501
    title: StrictStr = Field(description="DELETEREQUEST_REQUESTED_NUMBER_OF_MESSAGES_EXCEEDS_LIMIT")
    type: StrictStr = Field(description="https://www.rvig.nl/brp/berichten-api/probleem/BBA-DELETE-F004")
    detail: StrictStr = Field(description="Het aantal berichten dat in dit verzoek verwijderd dient te worden overschrijft het ingestelde limiet")
