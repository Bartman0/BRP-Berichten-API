...
class BBAF999(BaseModel):
    """
    Onbekende (/technische) fout.
    """ # noqa: E501
    title: StrictStr = Field(description="TECHNICAL_ERROR")
    type: StrictStr = Field(description="https://www.rvig.nl/brp/berichten-api/probleem/BBA-F999")
    detail: Optional[StrictStr] = Field(default=None, description="Onbekende (/technische) fout.")
