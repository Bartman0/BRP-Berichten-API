...
class BBAGETF001(BaseModel):
    """
    Het bericht is niet langer beschikbaar omdat de retentietijd verstreken is.
    """ # noqa: E501
    title: StrictStr = Field(description="GETREQUEST_MESSAGE_CONTENT_EXPIRED")
    type: StrictStr = Field(description="https://www.rvig.nl/brp/berichten-api/probleem/BBA-GET-F001")
