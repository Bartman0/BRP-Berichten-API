...
class BBAGETF002(BaseModel):
    """
    Het bericht is niet langer beschikbaar omdat het verwijderd is.
    """ # noqa: E501
    title: StrictStr = Field(description="GETREQUEST_MESSAGE_CONTENT_DELETED")
    type: StrictStr = Field(description="https://www.rvig.nl/brp/berichten-api/probleem/BBA-GET-F002")
    detail: StrictStr = Field(description="Het bericht is niet langer beschikbaar omdat het verwijderd is.")
