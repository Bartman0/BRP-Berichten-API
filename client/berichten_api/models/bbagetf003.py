...
class BBAGETF003(BaseModel):
    """
    Onbekend berichtTransportId
    """ # noqa: E501
    title: StrictStr = Field(description="GETREQUEST_MESSAGE_NOT_FOUND")
    type: StrictStr = Field(description="https://www.rvig.nl/brp/berichten-api/probleem/BBA-GET-F003")
