...
class BBAGETF004(BaseModel):
    """
    Het aantal opgevraagde berichten overschreed het ingestelde limiet
    """ # noqa: E501
    title: StrictStr = Field(description="GETREQUEST_REQUESTED_NUMBER_OF_MESSAGES_EXCEEDS_LIMIT")
    type: StrictStr = Field(description="https://www.rvig.nl/brp/berichten-api/probleem/BBA-GET-F004")
    detail: StrictStr = Field(description="Het aantal opgevraagde berichten overschreed het ingestelde limiet")
