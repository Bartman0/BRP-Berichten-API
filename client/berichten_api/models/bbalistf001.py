...
class BBALISTF001(BaseModel):
    """
    Ongeldige zoekfilters opgegeven
    """ # noqa: E501
    title: StrictStr = Field(description="LIST_MESSAGE_REQUEST_INVALID_PARAMETERS")
    type: StrictStr = Field(description="https://www.rvig.nl/brp/berichten-api/probleem/BBA-LIST-F001")
    detail: StrictStr = Field(description="Ongeldige zoekfilters opgegeven")
