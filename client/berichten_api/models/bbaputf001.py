...
class BBAPUTF001(BaseModel):
    """
    Het aantal berichten in het verzoek overschrijd het ingestelde limiet
    """ # noqa: E501
    title: StrictStr = Field(description="PUTREQUEST_NUMBER_OF_MESSAGES_IN_REQUEST_EXCEEDS_LIMITS")
    type: StrictStr = Field(description="https://www.rvig.nl/brp/berichten-api/probleem/BBA-PUT-F001")
    detail: StrictStr = Field(description="Het aantal berichten in het verzoek overschrijd het ingestelde limiet")
