...
class BBAPUTF002(BaseModel):
    """
    Een of meerdere velden in het bericht voldoen niet aan de gestelde eisen
    """ # noqa: E501
    title: StrictStr = Field(description="PUTREQUEST_INVALID_FIELD_ERROR")
    type: StrictStr = Field(description="https://www.rvig.nl/brp/berichten-api/probleem/BBA-PUT-F002")
    detail: StrictStr = Field(description="Een of meerdere velden in het bericht voldoen niet aan de gestelde eisen")
    ...
    __properties: ClassVar[List[str]] = ["title", "type", "detail", "dateTime", "invalidParameters"]
