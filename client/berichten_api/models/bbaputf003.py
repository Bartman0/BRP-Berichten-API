...
class BBAPUTF003(BaseModel):
    """
    Het bericht kon niet verzonden worden aan de geadresseerde
    """ # noqa: E501
    title: StrictStr = Field(description="PUTREQUEST_MESSAGE_COULD_NOT_BE_SEND")
    type: StrictStr = Field(description="https://www.rvig.nl/brp/berichten-api/probleem/BBA-PUT-F003")
    detail: StrictStr = Field(description="Het bericht kon niet verzonden worden aan de geadresseerde")
