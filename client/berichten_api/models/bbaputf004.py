...
class BBAPUTF004(BaseModel):
    """
    Het bericht kon niet verzonden worden, uw account is niet beschikbaar
    """ # noqa: E501
    title: StrictStr = Field(description="PUTREQUEST_SENDER_ACCOUNT_NOT_AVAILABLE")
    type: StrictStr = Field(description="https://www.rvig.nl/brp/berichten-api/probleem/BBA-PUT-F004")
    detail: StrictStr = Field(description="Het bericht kon niet verzonden worden, uw account is niet beschikbaar")
