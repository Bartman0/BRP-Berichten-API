...
class BBASUMMARIZEF001(BaseModel):
    """
    Het verzoek is onjuist controleer de zoekparameters.
    """ # noqa: E501
    title: StrictStr = Field(description="SUMMARIZEREQUEST_INVALID_REQUEST_ERROR")
    type: StrictStr = Field(description="https://www.rvig.nl/brp/berichten-api/probleem/BBA-SUMMARIZE-F001")
    detail: Optional[StrictStr] = Field(default=None, description="Het verzoek is onjuist controleer de zoekparameters.")
    ...
    __properties: ClassVar[List[str]] = ["title", "type", "detail", "dateTime", "invalidParameters", "instance"]
