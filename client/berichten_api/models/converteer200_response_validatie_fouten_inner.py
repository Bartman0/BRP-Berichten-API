...
class Converteer200ResponseValidatieFoutenInner(BaseModel):
    """
    ...
    evaluation_path: Optional[StrictStr] = Field(default=None, alias="evaluationPath")
    schema_location: Optional[StrictStr] = Field(default=None, alias="schemaLocation")
    message_key: Optional[StrictStr] = Field(default=None, alias="messageKey")
    arguments: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["type", "code", "message", "property", "evaluationPath", "schemaLocation", "messageKey", "arguments"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "evaluationPath": obj.get("evaluationPath"),
