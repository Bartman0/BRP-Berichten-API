...
CONVERTEER400RESPONSE_ONE_OF_SCHEMAS = ["BBACONVF001", "BBACONVF002", "BBACONVF003", "BBACONVF004", "BBACONVF005", "BBACONVF006", "BBAF999"]

class Converteer400Response(BaseModel):
    """
    Converteer400Response
    """
    # data type: BBACONVF001
    oneof_schema_1_validator: Optional[BBACONVF001] = None
    # data type: BBACONVF002
    oneof_schema_2_validator: Optional[BBACONVF002] = None
    # data type: BBACONVF003
    oneof_schema_3_validator: Optional[BBACONVF003] = None
    # data type: BBACONVF004
    oneof_schema_4_validator: Optional[BBACONVF004] = None
    # data type: BBACONVF005
    oneof_schema_5_validator: Optional[BBACONVF005] = None
    # data type: BBACONVF006
    oneof_schema_6_validator: Optional[BBACONVF006] = None
    # data type: BBAF999
    oneof_schema_7_validator: Optional[BBAF999] = None
    actual_instance: Optional[Union[BBACONVF001, BBACONVF002, BBACONVF003, BBACONVF004, BBACONVF005, BBACONVF006, BBAF999]] = None
    one_of_schemas: Set[str] = { "BBACONVF001", "BBACONVF002", "BBACONVF003", "BBACONVF004", "BBACONVF005", "BBACONVF006", "BBAF999" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = Converteer400Response.model_construct()
        error_messages = []
        match = 0
        # validate data type: BBACONVF001
        if not isinstance(v, BBACONVF001):
            error_messages.append(f"Error! Input type `{type(v)}` is not `BBACONVF001`")
        else:
            match += 1
        # validate data type: BBACONVF002
        if not isinstance(v, BBACONVF002):
            error_messages.append(f"Error! Input type `{type(v)}` is not `BBACONVF002`")
        else:
            match += 1
        # validate data type: BBACONVF003
        if not isinstance(v, BBACONVF003):
            error_messages.append(f"Error! Input type `{type(v)}` is not `BBACONVF003`")
        else:
            match += 1
        # validate data type: BBACONVF004
        if not isinstance(v, BBACONVF004):
            error_messages.append(f"Error! Input type `{type(v)}` is not `BBACONVF004`")
        else:
            match += 1
        # validate data type: BBACONVF005
        if not isinstance(v, BBACONVF005):
            error_messages.append(f"Error! Input type `{type(v)}` is not `BBACONVF005`")
        else:
            match += 1
        # validate data type: BBACONVF006
        if not isinstance(v, BBACONVF006):
            error_messages.append(f"Error! Input type `{type(v)}` is not `BBACONVF006`")
        else:
            match += 1
        # validate data type: BBAF999
        if not isinstance(v, BBAF999):
            error_messages.append(f"Error! Input type `{type(v)}` is not `BBAF999`")
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in Converteer400Response with oneOf schemas: BBACONVF001, BBACONVF002, BBACONVF003, BBACONVF004, BBACONVF005, BBACONVF006, BBAF999. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in Converteer400Response with oneOf schemas: BBACONVF001, BBACONVF002, BBACONVF003, BBACONVF004, BBACONVF005, BBACONVF006, BBAF999. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # check if data type is `BBACONVF004`
        if _data_type == "https://www.rvig.nl/brp/berichten-api/probleem/BBA-CONV-F004":
            instance.actual_instance = BBACONVF004.from_json(json_str)
            return instance

        # check if data type is `BBACONVF006`
        if _data_type == "https://www.rvig.nl/brp/berichten-api/probleem/BBA-CONV-F006":
            instance.actual_instance = BBACONVF006.from_json(json_str)
            return instance

        # check if data type is `BBAF999`
        if _data_type == "https://www.rvig.nl/brp/berichten-api/probleem/BBA-F999":
            instance.actual_instance = BBAF999.from_json(json_str)
            return instance

        # check if data type is `BBACONVF001`
        if _data_type == "BBA-CONV-F001":
            instance.actual_instance = BBACONVF001.from_json(json_str)
            return instance

        # check if data type is `BBACONVF002`
        if _data_type == "BBA-CONV-F002":
            instance.actual_instance = BBACONVF002.from_json(json_str)
            return instance

        # check if data type is `BBACONVF003`
        if _data_type == "BBA-CONV-F003":
            instance.actual_instance = BBACONVF003.from_json(json_str)
            return instance

        # check if data type is `BBACONVF004`
        if _data_type == "BBA-CONV-F004":
            instance.actual_instance = BBACONVF004.from_json(json_str)
            return instance

        # check if data type is `BBACONVF005`
        if _data_type == "BBA-CONV-F005":
            instance.actual_instance = BBACONVF005.from_json(json_str)
            return instance

        # check if data type is `BBACONVF006`
        if _data_type == "BBA-CONV-F006":
            instance.actual_instance = BBACONVF006.from_json(json_str)
            return instance

        # check if data type is `BBAF999`
        if _data_type == "BBA-F999":
            instance.actual_instance = BBAF999.from_json(json_str)
            return instance

        # deserialize data into BBACONVF001
        try:
            instance.actual_instance = BBACONVF001.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into BBACONVF002
        try:
            instance.actual_instance = BBACONVF002.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into BBACONVF003
        try:
            instance.actual_instance = BBACONVF003.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into BBACONVF004
        try:
            instance.actual_instance = BBACONVF004.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into BBACONVF005
        try:
            instance.actual_instance = BBACONVF005.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into BBACONVF006
        try:
            instance.actual_instance = BBACONVF006.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into BBAF999
        try:
            instance.actual_instance = BBAF999.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into Converteer400Response with oneOf schemas: BBACONVF001, BBACONVF002, BBACONVF003, BBACONVF004, BBACONVF005, BBACONVF006, BBAF999. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Converteer400Response with oneOf schemas: BBACONVF001, BBACONVF002, BBACONVF003, BBACONVF004, BBACONVF005, BBACONVF006, BBAF999. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], BBACONVF001, BBACONVF002, BBACONVF003, BBACONVF004, BBACONVF005, BBACONVF006, BBAF999]]:
