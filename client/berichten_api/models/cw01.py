...
class Cw01(BaseModel):
    ...
    bericht_type: Annotated[str, Field(min_length=0, strict=True, max_length=4)] = Field(alias="berichtType")
    herhaling: Annotated[str, Field(min_length=0, strict=True, max_length=1)]
    afnemersindicatie: Annotated[str, Field(min_length=0, strict=True, max_length=6)]
    datum_ingang: Annotated[str, Field(min_length=0, strict=True, max_length=8)] = Field(alias="datumIngang")
    datum_einde: Annotated[str, Field(min_length=0, strict=True, max_length=8)] = Field(alias="datumEinde")
    autorisatietabelregel: Autorisatietabelregel
    __properties: ClassVar[List[str]] = ["$schema", "berichtType", "herhaling", "afnemersindicatie", "datumIngang", "datumEinde", "autorisatietabelregel"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of autorisatietabelregel
        if self.autorisatietabelregel:
            _dict['autorisatietabelregel'] = self.autorisatietabelregel.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "herhaling": obj.get("herhaling"),
            "afnemersindicatie": obj.get("afnemersindicatie"),
            "datumIngang": obj.get("datumIngang"),
            "datumEinde": obj.get("datumEinde"),
            "autorisatietabelregel": Autorisatietabelregel.from_dict(obj["autorisatietabelregel"]) if obj.get("autorisatietabelregel") is not None else None
        })
        return _obj
