...
class DeleteMessageAntwoord(BaseModel):
    """
    ...
    succesvol_verwijderde_berichten: Optional[List[StrictStr]] = Field(default=None, description="In deze collectie staan de berichten die daadwerkelijk verwijderd zijn.", alias="succesvolVerwijderdeBerichten")
    niet_succesvol_verwijderde_berichten: Optional[List[DeleteMessageAntwoordAllOfNietSuccesvolVerwijderdeBerichten]] = Field(default=None, description="In deze collectie staan de berichten die niet verwijderd konden worden.", alias="nietSuccesvolVerwijderdeBerichten")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["interactieId", "succesvolVerwijderdeBerichten", "nietSuccesvolVerwijderdeBerichten"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in niet_succesvol_verwijderde_berichten (list)
        _items = []
        if self.niet_succesvol_verwijderde_berichten:
            for _item_niet_succesvol_verwijderde_berichten in self.niet_succesvol_verwijderde_berichten:
                if _item_niet_succesvol_verwijderde_berichten:
                    _items.append(_item_niet_succesvol_verwijderde_berichten.to_dict())
            _dict['nietSuccesvolVerwijderdeBerichten'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "succesvolVerwijderdeBerichten": obj.get("succesvolVerwijderdeBerichten"),
            "nietSuccesvolVerwijderdeBerichten": [DeleteMessageAntwoordAllOfNietSuccesvolVerwijderdeBerichten.from_dict(_item) for _item in obj["nietSuccesvolVerwijderdeBerichten"]] if obj.get("nietSuccesvolVerwijderdeBerichten") is not None else None
        })
