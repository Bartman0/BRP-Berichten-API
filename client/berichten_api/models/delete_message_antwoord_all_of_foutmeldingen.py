...
DELETEMESSAGEANTWOORDALLOFFOUTMELDINGEN_ONE_OF_SCHEMAS = ["BBADELETEF001", "BBADELETEF002", "BBADELETEF003"]

class DeleteMessageAntwoordAllOfFoutmeldingen(BaseModel):
    """
    DeleteMessageAntwoordAllOfFoutmeldingen
    """
    # data type: BBADELETEF001
    oneof_schema_1_validator: Optional[BBADELETEF001] = None
    # data type: BBADELETEF002
    oneof_schema_2_validator: Optional[BBADELETEF002] = None
    # data type: BBADELETEF003
    oneof_schema_3_validator: Optional[BBADELETEF003] = None
    actual_instance: Optional[Union[BBADELETEF001, BBADELETEF002, BBADELETEF003]] = None
    one_of_schemas: Set[str] = { "BBADELETEF001", "BBADELETEF002", "BBADELETEF003" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = DeleteMessageAntwoordAllOfFoutmeldingen.model_construct()
        error_messages = []
        match = 0
        # validate data type: BBADELETEF001
        if not isinstance(v, BBADELETEF001):
            error_messages.append(f"Error! Input type `{type(v)}` is not `BBADELETEF001`")
        else:
            match += 1
        # validate data type: BBADELETEF002
        if not isinstance(v, BBADELETEF002):
            error_messages.append(f"Error! Input type `{type(v)}` is not `BBADELETEF002`")
        else:
            match += 1
        # validate data type: BBADELETEF003
        if not isinstance(v, BBADELETEF003):
            error_messages.append(f"Error! Input type `{type(v)}` is not `BBADELETEF003`")
        else:
            match += 1
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in DeleteMessageAntwoordAllOfFoutmeldingen with oneOf schemas: BBADELETEF001, BBADELETEF002, BBADELETEF003. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in DeleteMessageAntwoordAllOfFoutmeldingen with oneOf schemas: BBADELETEF001, BBADELETEF002, BBADELETEF003. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # check if data type is `BBADELETEF001`
        if _data_type == "https://www.rvig.nl/brp/berichten-api/probleem/BBA-DELETE-F001":
            instance.actual_instance = BBADELETEF001.from_json(json_str)
            return instance

        # check if data type is `BBADELETEF002`
        if _data_type == "https://www.rvig.nl/brp/berichten-api/probleem/BBA-DELETE-F002":
            instance.actual_instance = BBADELETEF002.from_json(json_str)
            return instance

        # check if data type is `BBADELETEF003`
        if _data_type == "https://www.rvig.nl/brp/berichten-api/probleem/BBA-DELETE-F003":
            instance.actual_instance = BBADELETEF003.from_json(json_str)
            return instance

        # check if data type is `BBADELETEF001`
        if _data_type == "BBA-DELETE-F001":
            instance.actual_instance = BBADELETEF001.from_json(json_str)
            return instance

        # check if data type is `BBADELETEF002`
        if _data_type == "BBA-DELETE-F002":
            instance.actual_instance = BBADELETEF002.from_json(json_str)
            return instance

        # check if data type is `BBADELETEF003`
        if _data_type == "BBA-DELETE-F003":
            instance.actual_instance = BBADELETEF003.from_json(json_str)
            return instance

        # deserialize data into BBADELETEF001
        try:
            instance.actual_instance = BBADELETEF001.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into BBADELETEF002
        try:
            instance.actual_instance = BBADELETEF002.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into BBADELETEF003
        try:
            instance.actual_instance = BBADELETEF003.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into DeleteMessageAntwoordAllOfFoutmeldingen with oneOf schemas: BBADELETEF001, BBADELETEF002, BBADELETEF003. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into DeleteMessageAntwoordAllOfFoutmeldingen with oneOf schemas: BBADELETEF001, BBADELETEF002, BBADELETEF003. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], BBADELETEF001, BBADELETEF002, BBADELETEF003]]:
