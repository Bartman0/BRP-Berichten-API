...
class DeleteMessageAntwoordAllOfNietSuccesvolVerwijderdeBerichten(BaseModel):
    """
    ...
    foutmeldingen: List[DeleteMessageAntwoordAllOfFoutmeldingen]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["berichtTransportId", "foutmeldingen"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "foutmeldingen": [DeleteMessageAntwoordAllOfFoutmeldingen.from_dict(_item) for _item in obj["foutmeldingen"]] if obj.get("foutmeldingen") is not None else None
        })
