...
class Dt01(BaseModel):
    ...
    te_wijzigen_tabel: Annotated[str, Field(min_length=0, strict=True, max_length=2)] = Field(alias="teWijzigenTabel")
    tabel_data: Dict[str, Any] = Field(description="Beschrijving van de inhoud van de tabelberichten", alias="tabelData")
    __properties: ClassVar[List[str]] = ["$schema", "berichtType", "herhaling", "teWijzigenTabel", "tabelData"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "teWijzigenTabel": obj.get("teWijzigenTabel"),
            "tabelData": obj.get("tabelData")
        })
        return _obj
