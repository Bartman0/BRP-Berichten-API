...
class GetMessageAntwoordAllOfNietOpgehaaldeBerichten(BaseModel):
    """
    ...
    foutmeldingen: List[GetMessageAntwoordAllOfFoutmeldingen]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "foutmeldingen": [GetMessageAntwoordAllOfFoutmeldingen.from_dict(_item) for _item in obj["foutmeldingen"]] if obj.get("foutmeldingen") is not None else None
        })
        return _obj
