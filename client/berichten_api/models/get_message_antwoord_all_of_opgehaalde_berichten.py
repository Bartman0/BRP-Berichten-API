...
class GetMessageAntwoordAllOfOpgehaaldeBerichten(BaseModel):
    """
    GetMessageAntwoordAllOfOpgehaaldeBerichten
    """ # noqa: E501
    bericht_kenmerken: GetMessageKenmerken = Field(alias="berichtKenmerken")
    bericht_inhoud: LoBericht = Field(alias="berichtInhoud")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["berichtKenmerken", "berichtInhoud"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of bericht_kenmerken
        if self.bericht_kenmerken:
            _dict['berichtKenmerken'] = self.bericht_kenmerken.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "berichtKenmerken": GetMessageKenmerken.from_dict(obj["berichtKenmerken"]) if obj.get("berichtKenmerken") is not None else None,
