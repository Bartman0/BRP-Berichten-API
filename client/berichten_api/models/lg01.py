...
class Lg01(BaseModel):
    ...
    datum_tijd: Annotated[str, Field(min_length=0, strict=True, max_length=17)] = Field(alias="datumTijd")
    a_nummer: Annotated[str, Field(min_length=0, strict=True, max_length=10)] = Field(alias="aNummer")
    oud_a_nummer: Annotated[str, Field(min_length=0, strict=True, max_length=10)] = Field(alias="oudANummer")
    pl_data: Lg01PlData = Field(alias="plData")
    __properties: ClassVar[List[str]] = ["$schema", "berichtType", "datumTijd", "aNummer", "oudANummer", "plData"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "datumTijd": obj.get("datumTijd"),
            "aNummer": obj.get("aNummer"),
            "oudANummer": obj.get("oudANummer"),
            "plData": Lg01PlData.from_dict(obj["plData"]) if obj.get("plData") is not None else None
        })
        return _obj
