...
LISTMESSAGES401RESPONSE_ONE_OF_SCHEMAS = ["BBAAUTHF001", "BBAAUTHF002", "BBAF999"]

class ListMessages401Response(BaseModel):
    """
    ListMessages401Response
    """
    # data type: BBAAUTHF001
    oneof_schema_1_validator: Optional[BBAAUTHF001] = None
    # data type: BBAAUTHF002
    oneof_schema_2_validator: Optional[BBAAUTHF002] = None
    # data type: BBAF999
    oneof_schema_3_validator: Optional[BBAF999] = None
    actual_instance: Optional[Union[BBAAUTHF001, BBAAUTHF002, BBAF999]] = None
    one_of_schemas: Set[str] = { "BBAAUTHF001", "BBAAUTHF002", "BBAF999" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = ListMessages401Response.model_construct()
        error_messages = []
        match = 0
        # validate data type: BBAAUTHF001
        if not isinstance(v, BBAAUTHF001):
            error_messages.append(f"Error! Input type `{type(v)}` is not `BBAAUTHF001`")
        else:
            match += 1
        # validate data type: BBAAUTHF002
        if not isinstance(v, BBAAUTHF002):
            error_messages.append(f"Error! Input type `{type(v)}` is not `BBAAUTHF002`")
        else:
            match += 1
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in ListMessages401Response with oneOf schemas: BBAAUTHF001, BBAAUTHF002, BBAF999. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in ListMessages401Response with oneOf schemas: BBAAUTHF001, BBAAUTHF002, BBAF999. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # check if data type is `BBAAUTHF001`
        if _data_type == "https://www.rvig.nl/brp/berichten-api/probleem/BBA-AUTH-F001":
            instance.actual_instance = BBAAUTHF001.from_json(json_str)
            return instance

        # check if data type is `BBAAUTHF002`
        if _data_type == "https://www.rvig.nl/brp/berichten-api/probleem/BBA-AUTH-F002":
            instance.actual_instance = BBAAUTHF002.from_json(json_str)
            return instance
        ...
        # check if data type is `BBAAUTHF001`
        if _data_type == "BBA-AUTH-F001":
            instance.actual_instance = BBAAUTHF001.from_json(json_str)
            return instance

        # check if data type is `BBAAUTHF002`
        if _data_type == "BBA-AUTH-F002":
            instance.actual_instance = BBAAUTHF002.from_json(json_str)
            return instance
        ...
        # deserialize data into BBAAUTHF001
        try:
            instance.actual_instance = BBAAUTHF001.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into BBAAUTHF002
        try:
            instance.actual_instance = BBAAUTHF002.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into ListMessages401Response with oneOf schemas: BBAAUTHF001, BBAAUTHF002, BBAF999. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ListMessages401Response with oneOf schemas: BBAAUTHF001, BBAAUTHF002, BBAF999. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], BBAAUTHF001, BBAAUTHF002, BBAF999]]:
