...
class PagineringResultaat(BaseModel):
    """
    PagineringResultaat
    """ # noqa: E501
    paginering_verzoek: PagineringVerzoek = Field(alias="pagineringVerzoek")
    totaal_aantal_berichten: StrictInt = Field(alias="totaalAantalBerichten")
    aantal_berichten_op_deze_pagina: StrictInt = Field(alias="aantalBerichtenOpDezePagina")
    aantal_paginas: StrictInt = Field(alias="aantalPaginas")
    huidige_pagina: StrictInt = Field(alias="huidigePagina")
    eerste_pagina: StrictBool = Field(alias="eerstePagina")
    laatste_pagina: StrictBool = Field(alias="laatstePagina")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["pagineringVerzoek", "totaalAantalBerichten", "aantalBerichtenOpDezePagina", "aantalPaginas", "huidigePagina", "eerstePagina", "laatstePagina"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of paginering_verzoek
        if self.paginering_verzoek:
            _dict['pagineringVerzoek'] = self.paginering_verzoek.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pagineringVerzoek": PagineringVerzoek.from_dict(obj["pagineringVerzoek"]) if obj.get("pagineringVerzoek") is not None else None,
            "totaalAantalBerichten": obj.get("totaalAantalBerichten") if obj.get("totaalAantalBerichten") is not None else 0,
            "aantalBerichtenOpDezePagina": obj.get("aantalBerichtenOpDezePagina") if obj.get("aantalBerichtenOpDezePagina") is not None else 2000,
            "aantalPaginas": obj.get("aantalPaginas") if obj.get("aantalPaginas") is not None else 3,
            "huidigePagina": obj.get("huidigePagina"),
            "eerstePagina": obj.get("eerstePagina"),
            "laatstePagina": obj.get("laatstePagina")
        })
