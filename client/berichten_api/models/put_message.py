...
class PutMessage(BaseModel):
    ...
    PutMessage
    """ # noqa: E501
    bericht_kenmerken: PutMessageKenmerken = Field(alias="berichtKenmerken")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "berichtKenmerken": PutMessageKenmerken.from_dict(obj["berichtKenmerken"]) if obj.get("berichtKenmerken") is not None else None,
