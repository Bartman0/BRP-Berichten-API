...
class PutMessageAntwoordAllOfNietVerwerkteBerichten(BaseModel):
    """
    PutMessageAntwoordAllOfNietVerwerkteBerichten
    """ # noqa: E501
    ontvanger: Optional[StrictInt] = None
    ...
    foutmeldingen: List[PutMessageAntwoordAllOfFoutmeldingen]
    __properties: ClassVar[List[str]] = ["ontvanger", "berichtId", "berichtTransportId", "foutmeldingen"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PutMessageAntwoordAllOfNietVerwerkteBerichten from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in foutmeldingen (list)
        _items = []
        if self.foutmeldingen:
            for _item_foutmeldingen in self.foutmeldingen:
                if _item_foutmeldingen:
                    _items.append(_item_foutmeldingen.to_dict())
            _dict['foutmeldingen'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PutMessageAntwoordAllOfNietVerwerkteBerichten from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "foutmeldingen": [PutMessageAntwoordAllOfFoutmeldingen.from_dict(_item) for _item in obj["foutmeldingen"]] if obj.get("foutmeldingen") is not None else None
        })
        return _obj
