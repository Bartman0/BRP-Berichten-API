...
class PutMessageKenmerken(BaseModel):
    """
    De PutMessageKenmerken lijken op de PutEnvelope zoals dat gebruikt werd bij de mailboxserver. Ten opzichte van de mailboxserver zijn een aantal velden komen te vervallen en sommige hebben een andere naam gekregen:   * Attention: Was gereserveerd voor toekomstig gebruik. In deze API niet langer relevant.   * ContentType: Dit veld had altijd een vaste waarde. In deze API niet langer relevant.   * DeferredDeliveryTime: Hiermee kon een gewenst tijdstip van aflevering aangegeven worden. Dit wordt niet door deze API ondersteund.   * OriginatorORName: Wordt niet door deze API ondersteund. Dit veld wordt afgeleid door uit het account waarmee u ingelogd bent.   * Priority: Dit veld had invloed op aflevertijden tussen MTA's. In deze API niet langer relevant.  Zie toelichting bij \"BerichtKenmerken\" voor verschillen t.o.v. de MessageHeading van de mailboxserver. 
    """ # noqa: E501
    ...
    ontvanger: Annotated[int, Field(le=9999999, strict=True)] = Field(description="Het unieke nummer van een verzender/ontvanger.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["berichtId", "verwijzingBerichtId", "berichtType", "ontvanger"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PutMessageKenmerken from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PutMessageKenmerken from a dict"""
        if obj is None:
            return None
