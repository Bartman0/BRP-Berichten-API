...
class PutMessageRequest(BaseModel):
    ...
    PutMessageRequest
    """ # noqa: E501
    berichten: List[PutMessage]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["berichten"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "berichten": [PutMessage.from_dict(_item) for _item in obj["berichten"]] if obj.get("berichten") is not None else None
        })
