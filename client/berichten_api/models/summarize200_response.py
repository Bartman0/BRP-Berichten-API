...
class Summarize200Response(BaseModel):
    """
    ...
    aantal_berichten: StrictInt = Field(description="Het aantal berichten dat voldeed aan de criteria.", alias="aantalBerichten")
    __properties: ClassVar[List[str]] = ["interactieId", "aantalBerichten"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "aantalBerichten": obj.get("aantalBerichten")
        })
        return _obj
