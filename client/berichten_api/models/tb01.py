...
class Tb01(BaseModel):
    ...
    gezochte_persoon: Annotated[str, Field(min_length=1, strict=True, max_length=2)] = Field(alias="gezochtePersoon")
    aktenummer: Annotated[str, Field(min_length=0, strict=True, max_length=7)]
    pl_data: Af01PlData = Field(alias="plData")
    __properties: ClassVar[List[str]] = ["$schema", "berichtType", "herhaling", "gezochtePersoon", "aktenummer", "plData"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "gezochtePersoon": obj.get("gezochtePersoon"),
            "aktenummer": obj.get("aktenummer"),
