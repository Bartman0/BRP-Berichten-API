...
class Tf21(BaseModel):
    ...
    foutreden: Annotated[str, Field(min_length=1, strict=True, max_length=1)]
    gemeente: Annotated[str, Field(min_length=0, strict=True, max_length=4)]
    a_nummer: Annotated[str, Field(min_length=0, strict=True, max_length=10)] = Field(alias="aNummer")
    rubrieken: List[Annotated[str, Field(min_length=6, strict=True, max_length=6)]]
    pl_data: Af01PlData = Field(alias="plData")
    __properties: ClassVar[List[str]] = ["$schema", "berichtType", "foutreden", "gemeente", "aNummer", "rubrieken", "plData"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of pl_data
        if self.pl_data:
            _dict['plData'] = self.pl_data.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "foutreden": obj.get("foutreden"),
            "gemeente": obj.get("gemeente"),
            "aNummer": obj.get("aNummer"),
            "rubrieken": obj.get("rubrieken"),
            "plData": Af01PlData.from_dict(obj["plData"]) if obj.get("plData") is not None else None
        })
        return _obj
