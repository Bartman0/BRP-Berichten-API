...
class Vb02(BaseModel):
    ...
    communicatiepartner_aan: Annotated[str, Field(min_length=0, strict=True, max_length=7)] = Field(alias="communicatiepartnerAan")
    communicatiepartner_van: Annotated[str, Field(min_length=0, strict=True, max_length=7)] = Field(alias="communicatiepartnerVan")
    vrije_tekst: StrictStr = Field(alias="vrijeTekst")
    __properties: ClassVar[List[str]] = ["$schema", "berichtType", "communicatiepartnerAan", "communicatiepartnerVan", "vrijeTekst"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "communicatiepartnerAan": obj.get("communicatiepartnerAan"),
            "communicatiepartnerVan": obj.get("communicatiepartnerVan"),
            "vrijeTekst": obj.get("vrijeTekst")
        })
        return _obj
