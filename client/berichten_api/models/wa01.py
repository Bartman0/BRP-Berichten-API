...
class Wa01(BaseModel):
    ...
    datum_geldigheid: Annotated[str, Field(min_length=0, strict=True, max_length=8)] = Field(alias="datumGeldigheid")
    pl_data: Af01PlData = Field(alias="plData")
    __properties: ClassVar[List[str]] = ["$schema", "berichtType", "herhaling", "aNummer", "datumGeldigheid", "plData"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "datumGeldigheid": obj.get("datumGeldigheid"),
