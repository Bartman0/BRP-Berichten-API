...
class Xf01(BaseModel):
    ...
    adresfunctie: Annotated[str, Field(min_length=1, strict=True, max_length=1)]
    identificatie: Annotated[str, Field(min_length=1, strict=True, max_length=1)]
    pl_data: Af01PlData = Field(alias="plData")
    __properties: ClassVar[List[str]] = ["$schema", "berichtType", "foutreden", "rubrieken", "adresfunctie", "identificatie", "plData"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "adresfunctie": obj.get("adresfunctie"),
