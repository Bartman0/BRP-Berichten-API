...
**e0610** | **str** | De datum waarop het huwelijk is voltrokken of het partnerschap is aangegaan. ⦿ Groep: Huwelijkssluiting/aangaan geregistreerd partnerschap (06) ⦿ Element: Datum huwelijkssluiting/aangaan geregistreerd partnerschap (06.10) | [optional] 
**e0620** | **str** | Een code, opgenomen in Tabel 33, Gemeententabel of een buitenlandse plaats of een plaatsbepaling, die aangeeft waar het huwelijk is voltrokken of het partnerschap is aangegaan. ⦿ Groep: Huwelijkssluiting/aangaan geregistreerd partnerschap (06) ⦿ Element: Plaats huwelijkssluiting/aangaan geregistreerd partnerschap (06.20) | [optional] 
**e0630** | **str** | Een code, opgenomen in Tabel 34, Landentabel, die het land aangeeft waar het huwelijk is voltrokken of het partnerschap is aangegaan. ⦿ Groep: Huwelijkssluiting/aangaan geregistreerd partnerschap (06) ⦿ Element: Land huwelijkssluiting/aangaan geregistreerd partnerschap (06.30) | [optional] 
**e0710** | **str** | De datum waarop het huwelijk/geregistreerd partnerschap is ontbonden of nietig verklaard. ⦿ Groep: Ontbinding huwelijk/geregistreerd partnerschap (07) ⦿ Element: Datum ontbinding huwelijk/geregistreerd partnerschap (07.10) | [optional] 
**e0720** | **str** | Een code, opgenomen in Tabel 33, Gemeententabel of een buitenlandse plaats of een plaatsbepaling die aangeeft waar het huwelijk/ geregistreerd partnerschap is ontbonden of nietig verklaard. ⦿ Groep: Ontbinding huwelijk/geregistreerd partnerschap (07) ⦿ Element: Plaats ontbinding huwelijk/geregistreerd partnerschap (07.20) | [optional] 
**e0730** | **str** | Een code, opgenomen in Tabel 34, Landentabel, die het land aangeeft waar het huwelijk/geregistreerd partnerschap is ontbonden of nietig verklaard. ⦿ Groep: Ontbinding huwelijk/geregistreerd partnerschap (07) ⦿ Element: Land ontbinding huwelijk/geregistreerd partnerschap (07.30) | [optional] 
**e0740** | **str** | Een code, opgenomen in Tabel 41, Tabel Reden ontbinding/ nietigverklaring huwelijk/geregistreerd partnerschap, die aangeeft om welke reden het huwelijk/geregistreerd partnerschap is ontbonden of nietig verklaard. ⦿ Groep: Ontbinding huwelijk/geregistreerd partnerschap (07) ⦿ Element: Reden ontbinding huwelijk/geregistreerd partnerschap (07.40) | [optional] 
**e1510** | **str** | Een aanduiding voor de soort verbintenis die is aangegaan. ⦿ Groep: Soort verbintenis (15) ⦿ Element: Soort verbintenis (15.10) | [optional] 
...
af01_pl_data_c05_inner_all_of_historie_inner_instance = Af01PlDataC05InnerAllOfHistorieInner.from_json(json)
# print the JSON string representation of the object
print(Af01PlDataC05InnerAllOfHistorieInner.to_json())

# convert the object into a dict
af01_pl_data_c05_inner_all_of_historie_inner_dict = af01_pl_data_c05_inner_all_of_historie_inner_instance.to_dict()
# create an instance of Af01PlDataC05InnerAllOfHistorieInner from a dict
af01_pl_data_c05_inner_all_of_historie_inner_from_dict = Af01PlDataC05InnerAllOfHistorieInner.from_dict(af01_pl_data_c05_inner_all_of_historie_inner_dict)
```
