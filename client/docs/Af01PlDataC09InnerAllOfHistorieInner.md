# Af01PlDataC09InnerAllOfHistorieInner
...
**e8910** | **str** | De indicatie dat een kind levenloos is geboren. ⦿ Groep: Registratie afstamming (89) ⦿ Element: Registratie betrekking (89.10) | [optional] 
...
json = "{}"
# create an instance of Af01PlDataC09InnerAllOfHistorieInner from a JSON string
af01_pl_data_c09_inner_all_of_historie_inner_instance = Af01PlDataC09InnerAllOfHistorieInner.from_json(json)
# print the JSON string representation of the object
print(Af01PlDataC09InnerAllOfHistorieInner.to_json())

# convert the object into a dict
af01_pl_data_c09_inner_all_of_historie_inner_dict = af01_pl_data_c09_inner_all_of_historie_inner_instance.to_dict()
# create an instance of Af01PlDataC09InnerAllOfHistorieInner from a dict
af01_pl_data_c09_inner_all_of_historie_inner_from_dict = Af01PlDataC09InnerAllOfHistorieInner.from_dict(af01_pl_data_c09_inner_all_of_historie_inner_dict)
```
