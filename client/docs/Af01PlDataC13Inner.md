...
**historie** | [**List[Af01PlDataC13InnerAllOfHistorieInner]**](Af01PlDataC13InnerAllOfHistorieInner.md) |  | [optional] 
...
json = "{}"
# create an instance of Af01PlDataC13Inner from a JSON string
af01_pl_data_c13_inner_instance = Af01PlDataC13Inner.from_json(json)
# print the JSON string representation of the object
print(Af01PlDataC13Inner.to_json())

# convert the object into a dict
af01_pl_data_c13_inner_dict = af01_pl_data_c13_inner_instance.to_dict()
# create an instance of Af01PlDataC13Inner from a dict
af01_pl_data_c13_inner_from_dict = Af01PlDataC13Inner.from_dict(af01_pl_data_c13_inner_dict)
```
