...
**e1810** | **str** | De datum waarop betrokkene niet meer zijn tijdelijk verblijfsadres op dit adres houdt. ⦿ Groep: Einde geldigheid (18) ⦿ Element: Einddatum geldigheid (18.10) | [optional] 
**e1910** | **str** | Beschrijving wat de relatie van de betrokken persoon met dit adres. ⦿ Groep: Type adres (19) ⦿ Element: Type adres (19.10) | [optional] 
...
af01_pl_data_c16_inner_all_of_historie_inner_instance = Af01PlDataC16InnerAllOfHistorieInner.from_json(json)
# print the JSON string representation of the object
print(Af01PlDataC16InnerAllOfHistorieInner.to_json())

# convert the object into a dict
af01_pl_data_c16_inner_all_of_historie_inner_dict = af01_pl_data_c16_inner_all_of_historie_inner_instance.to_dict()
# create an instance of Af01PlDataC16InnerAllOfHistorieInner from a dict
af01_pl_data_c16_inner_all_of_historie_inner_from_dict = Af01PlDataC16InnerAllOfHistorieInner.from_dict(af01_pl_data_c16_inner_all_of_historie_inner_dict)
```
