...
lg01_pl_data_instance = Lg01PlData.from_json(json)
# print the JSON string representation of the object
print(Lg01PlData.to_json())

# convert the object into a dict
lg01_pl_data_dict = lg01_pl_data_instance.to_dict()
# create an instance of Lg01PlData from a dict
lg01_pl_data_from_dict = Lg01PlData.from_dict(lg01_pl_data_dict)
```
