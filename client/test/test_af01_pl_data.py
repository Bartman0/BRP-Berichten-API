...
class TestAf01PlData(unittest.TestCase):
    """Af01PlData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Af01PlData:
        """Test Af01PlData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Af01PlData`
        """
        model = Af01PlData()
        if include_optional:
            return Af01PlData(
