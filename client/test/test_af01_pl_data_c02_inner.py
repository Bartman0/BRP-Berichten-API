...
class TestAf01PlDataC02Inner(unittest.TestCase):
    """Af01PlDataC02Inner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Af01PlDataC02Inner:
        """Test Af01PlDataC02Inner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Af01PlDataC02Inner`
        """
        model = Af01PlDataC02Inner()
        if include_optional:
            return Af01PlDataC02Inner(
                e0110 = '4807288800',
                e0120 = '480728880',
                e0210 = '',
                e0220 = 'iO',
                ...
                e8610 = '48072888',
                historie = [
                    berichten_api.models.af01_pl_data_c02_inner_all_of_historie_inner.Af01_plData_c02_inner_allOf_historie_inner()
                    ]
            )
        else:
            return Af01PlDataC02Inner(
    ...
    def testAf01PlDataC02Inner(self):
        """Test Af01PlDataC02Inner"""
