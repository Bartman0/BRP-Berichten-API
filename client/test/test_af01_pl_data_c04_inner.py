...
class TestAf01PlDataC04Inner(unittest.TestCase):
    """Af01PlDataC04Inner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Af01PlDataC04Inner:
        """Test Af01PlDataC04Inner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Af01PlDataC04Inner`
        """
        model = Af01PlDataC04Inner()
        if include_optional:
            return Af01PlDataC04Inner(
                e0510 = '',
                e6310 = '',
                e6410 = '',
                e6510 = '',
                ...
                e8820 = '',
                historie = [
                    berichten_api.models.af01_pl_data_c04_inner_all_of_historie_inner.Af01_plData_c04_inner_allOf_historie_inner()
                    ]
            )
        else:
            return Af01PlDataC04Inner(
    ...
    def testAf01PlDataC04Inner(self):
        """Test Af01PlDataC04Inner"""
