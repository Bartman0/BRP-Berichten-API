...
class TestAf01PlDataC06Inner(unittest.TestCase):
    """Af01PlDataC06Inner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Af01PlDataC06Inner:
        """Test Af01PlDataC06Inner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Af01PlDataC06Inner`
        """
        model = Af01PlDataC06Inner()
        if include_optional:
            return Af01PlDataC06Inner(
                e0810 = '48072888',
                e0820 = '',
                e0830 = '',
                e8110 = '',
                ...
                e8820 = '',
                historie = [
                    berichten_api.models.af01_pl_data_c06_inner_all_of_historie_inner.Af01_plData_c06_inner_allOf_historie_inner()
                    ]
            )
        else:
            return Af01PlDataC06Inner(
    ...
    def testAf01PlDataC06Inner(self):
        """Test Af01PlDataC06Inner"""
