...
class TestAf01PlDataC06InnerAllOfHistorieInner(unittest.TestCase):
    """Af01PlDataC06InnerAllOfHistorieInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Af01PlDataC06InnerAllOfHistorieInner:
        """Test Af01PlDataC06InnerAllOfHistorieInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Af01PlDataC06InnerAllOfHistorieInner`
        """
        model = Af01PlDataC06InnerAllOfHistorieInner()
        if include_optional:
            return Af01PlDataC06InnerAllOfHistorieInner(
                e0810 = '48072888',
                e0820 = '',
                e0830 = '',
                e8110 = '',
    ...
    def testAf01PlDataC06InnerAllOfHistorieInner(self):
        """Test Af01PlDataC06InnerAllOfHistorieInner"""
