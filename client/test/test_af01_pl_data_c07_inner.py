...
class TestAf01PlDataC07Inner(unittest.TestCase):
    """Af01PlDataC07Inner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Af01PlDataC07Inner:
        """Test Af01PlDataC07Inner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Af01PlDataC07Inner`
        """
        model = Af01PlDataC07Inner()
        if include_optional:
            return Af01PlDataC07Inner(
                e6620 = '48072888',
                e6710 = '48072888',
                e6720 = '',
                e6810 = '48072888',
                ...
                e8820 = '',
                historie = [
                    berichten_api.models.af01_pl_data_c07_inner_all_of_historie_inner.Af01_plData_c07_inner_allOf_historie_inner()
                    ]
            )
        else:
            return Af01PlDataC07Inner(
    ...
    def testAf01PlDataC07Inner(self):
        """Test Af01PlDataC07Inner"""
