...
class TestAf01PlDataC08Inner(unittest.TestCase):
    """Af01PlDataC08Inner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Af01PlDataC08Inner:
        """Test Af01PlDataC08Inner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Af01PlDataC08Inner`
        """
        model = Af01PlDataC08Inner()
        if include_optional:
            return Af01PlDataC08Inner(
                e0910 = '',
                e0920 = '48072888',
                e1010 = '',
                e1020 = '',
                ...
                e8820 = '',
                historie = [
                    berichten_api.models.af01_pl_data_c08_inner_all_of_historie_inner.Af01_plData_c08_inner_allOf_historie_inner()
                    ]
            )
        else:
            return Af01PlDataC08Inner(
    ...
    def testAf01PlDataC08Inner(self):
        """Test Af01PlDataC08Inner"""
