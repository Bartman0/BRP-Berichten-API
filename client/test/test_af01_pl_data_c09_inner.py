...
class TestAf01PlDataC09Inner(unittest.TestCase):
    """Af01PlDataC09Inner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Af01PlDataC09Inner:
        """Test Af01PlDataC09Inner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Af01PlDataC09Inner`
        """
        model = Af01PlDataC09Inner()
        if include_optional:
            return Af01PlDataC09Inner(
                e0110 = '4807288800',
                e0120 = '480728880',
                e0210 = '',
                e0220 = 'iO',
                ...
                e8910 = '',
                historie = [
                    berichten_api.models.af01_pl_data_c09_inner_all_of_historie_inner.Af01_plData_c09_inner_allOf_historie_inner()
                    ]
            )
        else:
            return Af01PlDataC09Inner(
    ...
    def testAf01PlDataC09Inner(self):
        """Test Af01PlDataC09Inner"""
