...
class TestAf01PlDataC10Inner(unittest.TestCase):
    """Af01PlDataC10Inner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Af01PlDataC10Inner:
        """Test Af01PlDataC10Inner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Af01PlDataC10Inner`
        """
        model = Af01PlDataC10Inner()
        if include_optional:
            return Af01PlDataC10Inner(
                e3910 = '',
                e3920 = '48072888',
                e3930 = '48072888',
                e8310 = '',
                ...
                e8610 = '48072888',
                historie = [
                    berichten_api.models.af01_pl_data_c10_inner_all_of_historie_inner.Af01_plData_c10_inner_allOf_historie_inner()
                    ]
            )
        else:
            return Af01PlDataC10Inner(
    ...
    def testAf01PlDataC10Inner(self):
        """Test Af01PlDataC10Inner"""
