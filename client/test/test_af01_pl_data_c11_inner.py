...
class TestAf01PlDataC11Inner(unittest.TestCase):
    """Af01PlDataC11Inner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Af01PlDataC11Inner:
        """Test Af01PlDataC11Inner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Af01PlDataC11Inner`
        """
        model = Af01PlDataC11Inner()
        if include_optional:
            return Af01PlDataC11Inner(
                e3210 = '',
                e3310 = '',
                e8210 = '',
                e8220 = '48072888',
                ...
                e8610 = '48072888',
                historie = [
                    berichten_api.models.af01_pl_data_c11_inner_all_of_historie_inner.Af01_plData_c11_inner_allOf_historie_inner()
                    ]
            )
        else:
            return Af01PlDataC11Inner(
    ...
    def testAf01PlDataC11Inner(self):
        """Test Af01PlDataC11Inner"""
