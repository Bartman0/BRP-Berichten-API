...
class TestAf01PlDataC12Inner(unittest.TestCase):
    """Af01PlDataC12Inner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Af01PlDataC12Inner:
        """Test Af01PlDataC12Inner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Af01PlDataC12Inner`
        """
        model = Af01PlDataC12Inner()
        if include_optional:
            return Af01PlDataC12Inner(
                e3510 = '',
                e3520 = '',
                e3530 = '48072888',
                e3540 = '',
                ...
                e8610 = '48072888',
                historie = [
                    berichten_api.models.af01_pl_data_c12_inner_all_of_historie_inner.Af01_plData_c12_inner_allOf_historie_inner()
                    ]
            )
        else:
            return Af01PlDataC12Inner(
    ...
    def testAf01PlDataC12Inner(self):
        """Test Af01PlDataC12Inner"""
