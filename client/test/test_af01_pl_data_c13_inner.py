...
class TestAf01PlDataC13Inner(unittest.TestCase):
    """Af01PlDataC13Inner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Af01PlDataC13Inner:
        """Test Af01PlDataC13Inner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Af01PlDataC13Inner`
        """
        model = Af01PlDataC13Inner()
        if include_optional:
            return Af01PlDataC13Inner(
                e3110 = '',
                e3120 = '48072888',
                e3130 = '48072888',
                e3140 = '',
                ...
                e8230 = '',
                historie = [
                    berichten_api.models.af01_pl_data_c13_inner_all_of_historie_inner.Af01_plData_c13_inner_allOf_historie_inner()
                    ]
            )
        else:
            return Af01PlDataC13Inner(
    ...
    def testAf01PlDataC13Inner(self):
        """Test Af01PlDataC13Inner"""
