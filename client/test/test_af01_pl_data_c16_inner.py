...
class TestAf01PlDataC16Inner(unittest.TestCase):
    """Af01PlDataC16Inner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Af01PlDataC16Inner:
        """Test Af01PlDataC16Inner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Af01PlDataC16Inner`
        """
        model = Af01PlDataC16Inner()
        if include_optional:
            return Af01PlDataC16Inner(
                e0910 = '',
                e0920 = '48072888',
                e1110 = '',
                e1115 = '',
                ...
                e8820 = '',
                historie = [
                    berichten_api.models.af01_pl_data_c16_inner_all_of_historie_inner.Af01_plData_c16_inner_allOf_historie_inner()
                    ]
            )
        else:
            return Af01PlDataC16Inner(
    ...
    def testAf01PlDataC16Inner(self):
        """Test Af01PlDataC16Inner"""
