...
class TestAf01PlDataC21Inner(unittest.TestCase):
    """Af01PlDataC21Inner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Af01PlDataC21Inner:
        """Test Af01PlDataC21Inner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Af01PlDataC21Inner`
        """
        model = Af01PlDataC21Inner()
        if include_optional:
            return Af01PlDataC21Inner(
                e0110 = '4807288800',
                e0120 = '480728880',
                e0210 = '',
                e0220 = 'iO',
                ...
                e8610 = '48072888',
                historie = [
                    berichten_api.models.af01_pl_data_c21_inner_all_of_historie_inner.Af01_plData_c21_inner_allOf_historie_inner()
                    ]
            )
        else:
            return Af01PlDataC21Inner(
    ...
    def testAf01PlDataC21Inner(self):
        """Test Af01PlDataC21Inner"""
