...
class TestAutorisatietabelregel(unittest.TestCase):
    """Autorisatietabelregel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Autorisatietabelregel:
        """Test Autorisatietabelregel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Autorisatietabelregel`
        """
        model = Autorisatietabelregel()
        if include_optional:
            return Autorisatietabelregel(
                e9510 = '012345',
                e9511 = [
                    '0'
                    ],
    ...
    def testAutorisatietabelregel(self):
        """Test Autorisatietabelregel"""
