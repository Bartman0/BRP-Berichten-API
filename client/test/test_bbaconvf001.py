...
class TestBBACONVF001(unittest.TestCase):
    """BBACONVF001 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BBACONVF001:
        """Test BBACONVF001
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BBACONVF001`
        """
        model = BBACONVF001()
        if include_optional:
            return BBACONVF001(
