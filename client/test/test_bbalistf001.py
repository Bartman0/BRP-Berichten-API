...
class TestBBALISTF001(unittest.TestCase):
    """BBALISTF001 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BBALISTF001:
        """Test BBALISTF001
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BBALISTF001`
        """
        model = BBALISTF001()
        if include_optional:
            return BBALISTF001(
