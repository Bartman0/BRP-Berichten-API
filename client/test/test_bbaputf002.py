...
class TestBBAPUTF002(unittest.TestCase):
    """BBAPUTF002 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BBAPUTF002:
        """Test BBAPUTF002
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BBAPUTF002`
        """
        model = BBAPUTF002()
        if include_optional:
            return BBAPUTF002(
