...
class TestBBASUMMARIZEF001(unittest.TestCase):
    """BBASUMMARIZEF001 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BBASUMMARIZEF001:
        """Test BBASUMMARIZEF001
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BBASUMMARIZEF001`
        """
        model = BBASUMMARIZEF001()
        if include_optional:
            return BBASUMMARIZEF001(
                title = '',
                type = '',
                detail = '',
