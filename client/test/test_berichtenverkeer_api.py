...
class TestBerichtenverkeerApi(unittest.TestCase):
    """BerichtenverkeerApi unit test stubs"""

    def setUp(self) -> None:
        self.api = BerichtenverkeerApi()
    ...
    def test_put_messages(self) -> None:
        """Test case for put_messages
