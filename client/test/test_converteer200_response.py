...
class TestConverteer200Response(unittest.TestCase):
    """Converteer200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Converteer200Response:
        """Test Converteer200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Converteer200Response`
        """
        model = Converteer200Response()
        if include_optional:
            return Converteer200Response(
                bericht_inhoud = None,
                validatie_fouten = [
                    berichten_api.models.converteer_200_response_validatie_fouten_inner.converteer_200_response_validatieFouten_inner(
                        type = '', 
                        code = '', 
                        message = '', 
                        property = '', 
    ...
    def testConverteer200Response(self):
        """Test Converteer200Response"""
