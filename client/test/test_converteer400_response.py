...
class TestConverteer400Response(unittest.TestCase):
    """Converteer400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Converteer400Response:
        """Test Converteer400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Converteer400Response`
        """
        model = Converteer400Response()
        if include_optional:
            return Converteer400Response(
                title = '',
                type = '',
                detail = '',
                invalid_parameters = [
    ...
    def testConverteer400Response(self):
        """Test Converteer400Response"""
