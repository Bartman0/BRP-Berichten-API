...
class TestConverteer406Response(unittest.TestCase):
    """Converteer406Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Converteer406Response:
        """Test Converteer406Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Converteer406Response`
        """
        model = Converteer406Response()
        if include_optional:
            return Converteer406Response(
                title = '',
                type = '',
                detail = '',
                invalid_parameters = [
    ...
    def testConverteer406Response(self):
        """Test Converteer406Response"""
