...
class TestFoutmelding(unittest.TestCase):
    """Foutmelding unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Foutmelding:
        """Test Foutmelding
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Foutmelding`
        """
        model = Foutmelding()
        if include_optional:
            return Foutmelding(
