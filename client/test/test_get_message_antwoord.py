...
class TestGetMessageAntwoord(unittest.TestCase):
    """GetMessageAntwoord unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMessageAntwoord:
        """Test GetMessageAntwoord
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMessageAntwoord`
        """
        model = GetMessageAntwoord()
        if include_optional:
            return GetMessageAntwoord(
                interactie_id = '',
                opgehaalde_berichten = [
                    berichten_api.models.get_message_antwoord_all_of_opgehaalde_berichten.get_message_antwoord_allOf_opgehaaldeBerichten(
                        bericht_kenmerken = null, 
                        bericht_inhoud = null, )
                    ],
                niet_opgehaalde_berichten = [
                    berichten_api.models.get_message_antwoord_all_of_niet_opgehaalde_berichten.get_message_antwoord_allOf_nietOpgehaaldeBerichten(
                        bericht_transport_id = '', 
                        foutmeldingen = [
                            null
                            ], )
                    ]
    ...
    def testGetMessageAntwoord(self):
        """Test GetMessageAntwoord"""
