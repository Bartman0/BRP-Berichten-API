...
class TestGetMessageKenmerken(unittest.TestCase):
    """GetMessageKenmerken unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetMessageKenmerken:
        """Test GetMessageKenmerken
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetMessageKenmerken`
        """
        model = GetMessageKenmerken()
        if include_optional:
            return GetMessageKenmerken(
                bericht_id = '',
    ...
    def testGetMessageKenmerken(self):
        """Test GetMessageKenmerken"""
