...
class TestLg01(unittest.TestCase):
    """Lg01 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Lg01:
        """Test Lg01
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Lg01`
        """
        model = Lg01()
        if include_optional:
            return Lg01(
                ...
                a_nummer = '',
                oud_a_nummer = '',
                pl_data = berichten_api.models.lg01_pl_data.Lg01_plData(
                    c01 = [
