...
class TestLg01PlData(unittest.TestCase):
    """Lg01PlData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Lg01PlData:
        """Test Lg01PlData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Lg01PlData`
        """
        model = Lg01PlData()
        if include_optional:
            return Lg01PlData(
