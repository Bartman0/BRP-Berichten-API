...
class TestListMessageAntwoord(unittest.TestCase):
    """ListMessageAntwoord unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListMessageAntwoord:
        """Test ListMessageAntwoord
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListMessageAntwoord`
        """
        model = ListMessageAntwoord()
        if include_optional:
            return ListMessageAntwoord(
                interactie_id = '',
    ...
    def testListMessageAntwoord(self):
        """Test ListMessageAntwoord"""
