...
class TestListMessageKenmerken(unittest.TestCase):
    """ListMessageKenmerken unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListMessageKenmerken:
        """Test ListMessageKenmerken
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListMessageKenmerken`
        """
        model = ListMessageKenmerken()
        if include_optional:
            return ListMessageKenmerken(
                bericht_id = '',
                verwijzing_bericht_id = '',
                bericht_type = '',
                bericht_transport_id = '',
                bericht_volgnummer = 56,
                afzender = 56,
                dt_ontvangen = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                opgehaald = True,
                dt_bewaard_tot = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f')
            )
        else:
            return ListMessageKenmerken(
                bericht_id = '',
    ...
    def testListMessageKenmerken(self):
        """Test ListMessageKenmerken"""
