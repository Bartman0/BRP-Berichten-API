...
class TestLoBericht(unittest.TestCase):
    """LoBericht unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LoBericht:
        """Test LoBericht
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LoBericht`
        """
        model = LoBericht()
        if include_optional:
            return LoBericht(
                ...
                gemeente = '',
                a_nummer = '',
                pl_data = berichten_api.models.af01_pl_data.Af01_plData(
                    c01 = [
                        berichten_api.models.af01_pl_data_c01_inner.Af01_plData_c01_inner()
                        ], 
                    c02 = [
                        berichten_api.models.af01_pl_data_c02_inner.Af01_plData_c02_inner()
                        ], 
                    c03 = [
                        berichten_api.models.af01_pl_data_c02_inner.Af01_plData_c02_inner()
                        ], 
                    c04 = [
                        berichten_api.models.af01_pl_data_c04_inner.Af01_plData_c04_inner()
                        ], 
                    c05 = [
                        berichten_api.models.af01_pl_data_c05_inner.Af01_plData_c05_inner()
                        ], 
                    c06 = [
                        berichten_api.models.af01_pl_data_c06_inner.Af01_plData_c06_inner()
                        ], 
                    c07 = [
                        berichten_api.models.af01_pl_data_c07_inner.Af01_plData_c07_inner()
                        ], 
                    c08 = [
                        berichten_api.models.af01_pl_data_c08_inner.Af01_plData_c08_inner()
                        ], 
                    c09 = [
                        berichten_api.models.af01_pl_data_c09_inner.Af01_plData_c09_inner()
                        ], 
                    c10 = [
                        berichten_api.models.af01_pl_data_c10_inner.Af01_plData_c10_inner()
                        ], 
                    c11 = [
                        berichten_api.models.af01_pl_data_c11_inner.Af01_plData_c11_inner()
                        ], 
                    c12 = [
                        berichten_api.models.af01_pl_data_c12_inner.Af01_plData_c12_inner()
                        ], 
                    c13 = [
                        berichten_api.models.af01_pl_data_c13_inner.Af01_plData_c13_inner()
                        ], 
                    c14 = [
                        berichten_api.models.af01_pl_data_c14_inner.Af01_plData_c14_inner()
                        ], 
                    c15 = [
                        berichten_api.models.af01_pl_data_c15_inner.Af01_plData_c15_inner()
                        ], 
                    c16 = [
                        berichten_api.models.af01_pl_data_c16_inner.Af01_plData_c16_inner()
                        ], 
                    c17 = [
                        berichten_api.models.af01_pl_data_c17_inner.Af01_plData_c17_inner()
                        ], 
                    c21 = [
                        berichten_api.models.af01_pl_data_c21_inner.Af01_plData_c21_inner()
                        ], ),
                status = '0',
                datum = '',
                herhaling = '',
                ...
                datum_ingang = '',
                datum_einde = '',
                autorisatietabelregel = berichten_api.models.autorisatietabelregel.autorisatietabelregel(
                    e9510 = '012345', 
                    e9511 = [
                        '0'
                        ], 
                    ...
                    e9999 = '', ),
                te_wijzigen_tabel = '',
                tabel_data = berichten_api.models.tabelberichten.Tabelberichten(),
                rubrieken = [
                    '012345'
                    ],
                datum_tijd = '',
                ...
                aktenummer = '',
                vrije_tekst = '',
                communicatiepartner_aan = '',
                communicatiepartner_van = '',
                datum_geldigheid = '',
                pl_data_set = [
                    berichten_api.models.af01_pl_data.Af01_plData(
                        c01 = [
                            berichten_api.models.af01_pl_data_c01_inner.Af01_plData_c01_inner()
                            ], 
                        c02 = [
