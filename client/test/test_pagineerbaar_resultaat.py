...
class TestPagineerbaarResultaat(unittest.TestCase):
    """PagineerbaarResultaat unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PagineerbaarResultaat:
        """Test PagineerbaarResultaat
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PagineerbaarResultaat`
        """
        model = PagineerbaarResultaat()
        if include_optional:
            return PagineerbaarResultaat(
                paginering = berichten_api.models.paginering_resultaat.PagineringResultaat(
                    paginering_verzoek = berichten_api.models.paginering_verzoek.PagineringVerzoek(
                        pagina = 0, ), 
                    totaal_aantal_berichten = 56, 
                    aantal_berichten_op_deze_pagina = 56, 
                    aantal_paginas = 56, 
                    huidige_pagina = 56, 
                    eerste_pagina = True, 
                    laatste_pagina = True, )
    ...
    def testPagineerbaarResultaat(self):
        """Test PagineerbaarResultaat"""
