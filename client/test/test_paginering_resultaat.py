...
class TestPagineringResultaat(unittest.TestCase):
    """PagineringResultaat unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PagineringResultaat:
        """Test PagineringResultaat
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PagineringResultaat`
        """
        model = PagineringResultaat()
        if include_optional:
            return PagineringResultaat(
    ...
    def testPagineringResultaat(self):
        """Test PagineringResultaat"""
