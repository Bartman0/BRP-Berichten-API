...
class TestPutMessageAntwoord(unittest.TestCase):
    """PutMessageAntwoord unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PutMessageAntwoord:
        """Test PutMessageAntwoord
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PutMessageAntwoord`
        """
        model = PutMessageAntwoord()
        if include_optional:
            return PutMessageAntwoord(
                interactie_id = '',
                verwerkte_berichten = [
                    berichten_api.models.put_message_antwoord_all_of_verwerkte_berichten.put_message_antwoord_allOf_verwerkteBerichten(
                        ontvanger = 56, 
                        bericht_id = '', 
                        bericht_transport_id = '', )
                    ],
                niet_verwerkte_berichten = [
                    berichten_api.models.put_message_antwoord_all_of_niet_verwerkte_berichten.put_message_antwoord_allOf_nietVerwerkteBerichten(
                        ontvanger = 56, 
                        bericht_id = '', 
                        bericht_transport_id = '', 
                        foutmeldingen = [
    ...
    def testPutMessageAntwoord(self):
        """Test PutMessageAntwoord"""
