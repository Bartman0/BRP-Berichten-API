...
class TestPutMessageAntwoordAllOfFoutmeldingen(unittest.TestCase):
    """PutMessageAntwoordAllOfFoutmeldingen unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PutMessageAntwoordAllOfFoutmeldingen:
        """Test PutMessageAntwoordAllOfFoutmeldingen
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PutMessageAntwoordAllOfFoutmeldingen`
        """
        model = PutMessageAntwoordAllOfFoutmeldingen()
        if include_optional:
            return PutMessageAntwoordAllOfFoutmeldingen(
                title = '',
                type = '',
                detail = '',
                date_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                invalid_parameters = [
                    berichten_api.models.invalid_parameters_inner.invalidParameters_inner(
                        key = '', 
                        value = '', )
                    ]
            )
    ...
    def testPutMessageAntwoordAllOfFoutmeldingen(self):
        """Test PutMessageAntwoordAllOfFoutmeldingen"""
